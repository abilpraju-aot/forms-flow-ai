...
export const formio_resourceBundles = {
  en: {
    ...
    "Ok": "Ok",
    "No submissions available for the selected date range":
      "No submissions available for the selected date range",
    "Save Form": "Save Form",
    "Cancel": "Cancel",
    "Confirm": "Confirm",
  ...
  "zh-CN": {
    ...
    "You can add a group by typing a group ID into the input field and afterwards clicking the button with the plus sign.":
      "您可以通过在输入字段中输入组 ID，然后单击带加号的按钮来添加组。",
    "Add a group": "添加群组",
    "Process Name": "进程名称",
    ...
    "Sets the tabindex attribute of this component to override the tab order of the form. See the MDN documentation on tabindex for more information.":
      "设置此组件的 tabindex 属性以覆盖表单的 Tab 键顺序。有关更多信息，请参阅有关 tabindex 的 MDN 文档。",
    "Autocomplete": "自动完成",
    "Indicates whether input elements can by default have their values automatically completed by the browser. See the MDN documentation on autocomplete for more information.":
      "指示默认情况下输入元素是否可以由浏览器自动完成其值。有关更多信息，请参阅有关自动完成的 MDN 文档。",
    "A hidden field is still a part of the form, but is hidden from view.":
      "隐藏字段仍然是表单的一部分，但在视图中是隐藏的。",
    "Hide Label": "隐藏标签",
    ...
    "Hide the label (title, if no label) of this component. This allows you to show the label in the form builder, but not when it is rendered.":
      "隐藏该组件的标签（标题，如果没有标签）。这允许您在表单构建器中显示标签，但在呈现时不显示",
    ...
    'Contextual "row" data, used within DataGrid, EditGrid, and Container components':
      "上下文“行”数据，在 DataGrid、EditGrid 和 Container 组件中使用",
    "component": "零件",
    ...
    'support is provided using an "_" before each operation, such as {"_sum": {var: "data.a"}}':
      '在每个操作之前使用“_”提供支持，例如 {"_sum": {var: "data.a"}}',
    "Full": "满的",
    ...
    "Checking this will run the calculation on the server. This is useful if you wish to override the values submitted with the calculations performed on the server.":
      "选中此项将在服务器上运行计算。如果您希望使用在服务器上执行的计算来覆盖提交的值，这将很有用。",
    ...
    "Check this if you wish to perform the validation ONLY on the server side. This keeps your validation logic private and secret.":
      "如果您希望仅在服务器端执行验证，请选中此项。这使您的验证逻辑保持私密和保密。",
    ...
    "Password fields are automatically encrypted using 1-way salted bcrypt hashes. These hashes are also protected and not returned in the API.":
      "密码字段使用单向加盐 bcrypt 哈希自动加密。这些哈希值也受到保护，不会在 API 中返回。",
    ...
    "The source to use for the select data. Values lets you provide your own values and labels. JSON lets you provide raw JSON data. URL lets you provide a URL to retrieve the JSON data from.":
      "用于选择数据的源。值允许您提供自己的值和标签。 JSON 允许您提供原始 JSON 数据。 URL 允许您提供一个 URL 以从中检索 JSON 数据。",
    "Values": "价值观",
    "on": "在",
    "Raw JSON": "原始 JSON",
    "IndexedDB": "索引数据库",
    ...
    "The type to store the data. If you select something other than autotype, it will force it to that type.":
      "存储数据的类型。如果您选择自动输入以外的其他内容，它将强制它使用该类型。",
    "Autotype": "复写",
    "Boolean": "布尔值",
    "Object": "目的",
    "ID Path": "标识路径",
    ...
    "This is the full icon class string to show the icon.":
      "这是显示图标的完整图标类字符串。例子：",
    "Right Icon": "右图标",
    "This is the full icon class string to show the icon. Example:":
      "这是显示图标的完整图标类字符串。例子：",
    "Primary": "基本的",
    "Secondary": "中学",
    "Info": "信息",
    ...
    "Specify template which should be when quering view string for the component value entered in manual mode. This string is used in table view, CSV export and email rendering. When left blank combined value of all components joined with comma will be used.":
      "指定在查询手动模式下输入的组件值的视图字符串时应使用的模板。此字符串用于表格视图、CSV 导出和电子邮件呈现。当留空时，将使用用逗号连接的所有组件的组合值。",
    "Azure Maps": "Azure 地图",
    "Google Maps": "谷歌地图",
    "API Key": "API 密钥",
    ...
    "Check this if you would like to allow the user to manually enter in the date.":
      "如果您希望允许用户手动输入日期，请​​选中此项。",
    "Format": "格式",
    "The date format for displaying the datetime value.":
      "用于显示日期时间值的日期格式。",
    "Shortcut Buttons": "快捷按钮",
    "You can specify few buttons which will be shown above the calendar. Use Label to specify the name of the button and onClick to specify which date/time will be set when user clicks the button. ":
      "您可以指定几个将显示在日历上方的按钮。使用 Label 指定按钮的名称，使用 onClick 指定用户单击按钮时将设置的日期/时间。",
    "onClick": "点击",
    "Enable Date Input": "启用日期输入",
    "Enables date input for this field.": "启用此字段的日期输入。",
    "Use Input to add moment.js for minDate":
      "使用 Input 为 minDate 添加 moment.js",
    ...
    "Use Input to add moment.js for maxDate":
      "使用 Input 为 maxDate 添加 moment.js",
    ...
    "You can use Moment.js functions to set the default value to a specific date. For example:":
      "您可以使用 Moment.js 函数将默认值设置为特定日期。例如：",
    ...
    "The attributes for this HTML element. Only safe attributes are allowed, such as src, href, and title.":
      "此 HTML 元素的属性。只允许使用安全属性，例如 src、href 和 title。",
    "Attribute": "属性",
    ...
    "Check this if you would like to hide any column when the children within that column are also hidden":
      "如果您想在该列中的子项也被隐藏时隐藏任何列，请选中此项",
    "Legend": "传奇",
    "The legend for this Fieldset.": "此字段集的图例。",
    "Default": "默认",
    "Collapsible": "可折叠",
    "If checked, this will turn this Panel into a collapsible panel.":
      "如果选中，这将把这个面板变成一个可折叠的面板。",
    "Number of Rows": "行数",
    ...
    "Using this option will save this field as a reference and link its value to the value of the origin record.":
      "使用此选项会将此字段保存为参考，并将其值链接到原始记录的值。",
    "Select Fields": "选择字段",
    "The properties on the resource to return as part of the options. If left blank, all properties will be returned.":
      "作为选项的一部分返回的资源的属性。如果留空，将返回所有属性。",
    "Search Fields": "搜索字段",
    "Filter Query": "过滤查询",
  ...
  bg: {
    ...
    "No submission avaliable in the selected date. Please select another date range":
      "Няма налично подаване на избраната дата. Моля, изберете друг период от време",
    "All groups have access to the dashboard":
      "Всички групи имат достъп до таблото",
    ...
    "Add form fields to display in task list":
      "Добавете полета на формуляра за показване в списъка със задачи",
    "Version": "Версия",
    ...
    "Ok": "Добре",
    "No submissions available for the selected date range":
      "Няма налични заявки за избрания период от време",
    "Save Form": "Запазване на формуляр",
    "Confirm": "Потвърдете",
    "Cancel": "Отмяна",
    "Wizard": "Магьосник",
    "Please fix the errors before submitting again.":
      "Моля, поправете грешките, преди да изпратите отново.",
    ...
    "Edit": "редактиране",
    "Do you want to associate form with a workflow ?":
      "Искате ли да свържете формата с работен поток?",
    "Yes": "да",
    "No": "Не",
    "Form Name": "Име на формуляра",
    "Workflow Name": "Име на работния процес",
    "Publish this form for Client Users.":
      "Публикувайте този формуляр за Клиентски потребители.",
    "Comments": "Коментари",
    "Back": "обратно",
    "Edit Form": "Редактиране на формуляр",
    "Next": "Следващия",
    "Are you sure you wish to delete this submission?":
      "Наистина ли искате да изтриете това изпращане?",
    "Save": "Запазете",
    ...
    "Please change the selected filters to view tasks":
      "Моля, променете избраните филтри, за да видите задачите",
    ...
    "For Variable, ignore case of":
      "За променлива, пренебрегвайте регистъра на",
    "value": "стойност",
    ...
    "You can add a group by typing a group ID into the input field and afterwards clicking the button with the plus sign.":
      "Можете да добавите група, като въведете идентификатор на групата в полето за въвеждане и след това щракнете върху бутона със знака плюс.",
    ...
    "Failed": "Се провали",
    "Press Enter key or click here to search":
      "Натиснете клавиша Enter или щракнете тук, за да търсите",
    ...
    "Associate this form with a workflow?":
      "Да се ​​свърже ли този формуляр с работен поток?",
    ...
    "Drag and Drop a form component":
      "Плъзнете и пуснете компоненти на формуляра",
    "Preview": "предварителен преглед",
    "The minimum length requirement this field must meet.":
      "Изисквания за минимална дължина, на които трябва да отговаря това поле",
    "Label": "Етикет",
    "The label for this field that will appear next to it.":
      "Етикетът, който ще се появи до това поле.",
    "Label Position": "позиция на етикета",
    "Position for the label for this field.":
      "Позицията на етикета за това поле.",
    "Placeholder": "Заместител",
    "The placeholder text that will appear when this field is empty.":
      "Текст за място, който ще се показва, когато това поле е празно.",
    "The description is text that will appear below the input field.":
      "Описанието е текстът, който ще се появи под полето за въвеждане.",
    "Tooltip": "подсказка",
    "Adds a tooltip to the side of this field.":
      "Добавете подсказка отстрани на това поле.",
    "To add a tooltip to this field, enter text here.":
      "За да добавите подсказка към това поле, въведете текст тук.",
    "Description for this field.": "Описание на това поле.",
    "Prefix": "префикс",
    "Suffix": "наставка",
    "Widget": "малки инструменти",
    "The widget is the display UI used to input the value of the field.":
      "Уиджетът е потребителски интерфейс на дисплея за въвеждане на стойности на полета.",
    ...
    "The width of label on line in percentages.":
      "Ширината на онлайн етикета (в проценти).",
    "Label Margin": "Поле на раздела",
    "The width of label margin on line in percentages.":
      "Ширината на полето на етикета на реда, изразена като процент.",
    "Rows": "Ред",
    ...
    "Custom CSS class to add to this component.":
      "Персонализиран CSS клас за добавяне към този компонент.",
    "Tab Index": "Индекс на маркери",
    "Sets the tabindex attribute of this component to override the tab order of the form. See the MDN documentation on tabindex for more information.":
      "Задайте свойството tabindex на този компонент да отменя реда на разделите на формуляра. За повече информация вижте документацията на MDN за tabindex.",
    "Autocomplete": "автоматично завършване",
    "Indicates whether input elements can by default have their values automatically completed by the browser. See the MDN documentation on autocomplete for more information.":
      "Показва дали входният елемент може автоматично да довършва стойността си от браузъра по подразбиране. За повече информация вижте документацията на MDN относно автоматичното довършване.",
    "A hidden field is still a part of the form, but is hidden from view.":
      "Скритите полета все още са част от формуляра, но са скрити от погледа.",
    "Hide Label": "скрий раздела",
    "Show Word Counter": "Показване на брояча на думи",
    "Show a live count of the number of words.":
      "Показва броя на думите в реално време.",
    "Hide the label (title, if no label) of this component. This allows you to show the label in the form builder, but not when it is rendered.":
      "Скрийте етикета (заглавие, ако няма етикет) за този компонент. Това ви позволява да покажете етикета в конструктора на формуляри, но не и когато е изобразен",
    "Show Character Counter": "Показване на брояча на знаците",
    "Show a live count of the number of characters.":
      "Показва броя на знаците в реално време.",
    "Hide Input": "скрит вход",
    "Hide the input in the browser. This does not encrypt on the server. Do not use for passwords.":
      "Скриване на въвеждане в браузъра. Това не е криптирано на сървъра. Не използвайте за пароли.",
    "Initial Focus": "първоначален фокус",
    "Make this field the initially focused element on this form.":
      "Направете това поле първоначално фокусиран елемент в този формуляр.",
    ...
    "Shows this value within the table view of the submissions.":
      "Покажете тази стойност в изпратения изглед на таблица.",
    "Modal Edit": "Модално редактиране",
    "Opens up a modal to edit the value of this component.":
      "Отваря модална програма за редактиране на стойността на този компонент.",
    "Multiple Values": "множество стойности",
    "Allows multiple values to be entered for this field.":
      "За това поле са разрешени множество стойности.",
    "Default Value": "По подразбиране",
    "The will be the value for this field, before user interaction. Having a default value will override the placeholder text.":
      "ще бъде стойността на това поле преди взаимодействието с потребителя. Наличието на стойност по подразбиране ще замени текста на заместителя.",
    "Persistent": "постоянен",
    "A persistent field will be stored in database when the form is submitted.":
      "Постоянните полета ще се съхраняват в базата данни, когато формулярът бъде изпратен.",
    "None": "Не всеки",
    "Server": "сървър",
    "Client": "клиент",
    "Input Format": "входен формат",
    "Force the output of this field to be sanitized in a specific format.":
      "Принуждава изхода на това поле да бъде дезинфекциран в определен формат.",
    "Plain": "ясно",
    "Type to search": "въведете търсене",
    "Raw (Insecure)": "суров (опасно)",
    "Protected": "защитени",
    "A protected field will not be returned when queried via API.":
      "Защитените полета не се връщат при запитване през API.",
    "Database Index": "индекс на базата данни",
    "Set this field as an index within the database. Increases performance for submission queries.":
      "Задайте това поле като индекс в базата данни. Подобрете ефективността на изпратените заявки.",
    "Text Case": "текстов случай",
    "When data is entered, you can change the case of the value.":
      "Когато въвеждате данни, можете да промените главния регистър на стойността.",
    ...
    "Encrypt this field on the server. This is two way encryption which is not suitable for passwords.":
      "Това поле е криптирано на сървъра. Това е двупосочно криптиране, което не е подходящо за пароли.",
    "Redraw On": "преначертавам",
    "Redraw this component if another component changes. This is useful if interpolating parts of the component like the label.":
      "Ако друг компонент се промени, преначертайте този компонент. Това е полезно при вмъкване на части от компоненти като етикети.",
    ...
    "When a field is hidden, clear the value.":
      "Когато полето е скрито, изчистете стойността.",
    "The following variables are available in all scripts.":
      "Следните променливи са налични във всички скриптове.",
    ...
    "The complete submission data object.":
      "Пълният обект с данни за подаване.",
    "row": "Ред",
    'Contextual "row" data, used within DataGrid, EditGrid, and Container components':
      'Контекстни "редови" данни, използвани в компонентите DataGrid, EditGrid и Container',
    "component": "Компоненти",
    ...
    "moment": "момент",
    "The moment.js library for date manipulation.":
      "moment.js библиотека за манипулиране на дати.",
    "utils": "полезност",
    "util": "полезност",
    ...
    'support is provided using an "_" before each operation, such as {"_sum": {var: "data.a"}}':
      'Използвайте "_" преди всяка операция, за да осигурите поддръжка, напр. {"_sum": {var: "data.a"}}',
    "Full": "пълен",
    "Calculated Value": "Изчислено",
    "token": "токен",
    "The decoded JWT token for the authenticated user.":
      "Декодираният JWT маркер на удостоверения потребител.",
    "Calculate Value on server": "Изчислете стойността на сървъра",
    "Checking this will run the calculation on the server. This is useful if you wish to override the values submitted with the calculations performed on the server.":
      "Поставете отметка в това, за да стартирате изчислението на сървъра. Това е полезно, ако искате да замените подадената стойност с изчисление, извършено на сървъра.",
    "Allow Manual Override of Calculated Value":
      "Разрешете ръчно отмяна на изчислените стойности",
    "When checked, this will allow the user to manually override the calculated value.":
      "Когато е отметнато, това ще позволи на потребителя ръчно да отмени изчислената стойност.",
    "Remove": "премахване",
    "Validate On": "Удостоверяването е включено",
    "Determines when this component should trigger front-end validation.":
      "Определя кога този компонент трябва да задейства проверка на интерфейса.",
    "Change": "Промяна",
    "Blur": "Неясно",
    "Required": "задължително",
    "A required field must be filled in before the form can be submitted.":
      "Задължителните полета трябва да бъдат попълнени, преди формулярът да може да бъде изпратен.",
    "Unique": "Уникален",
    "Makes sure the data submitted for this field is unique, and has not been submitted before.":
      "Уверете се, че данните, изпратени за това поле, са уникални и не са били изпращани преди.",
    "Minimum Length": "Минимална дължина",
    "The maximum length requirement this field must meet.":
      "Изискването за максимална дължина, на което трябва да отговаря това поле.",
    "Maximum Length": "Максимална дължина",
    "Minimum Word Length": "Минимална дължина на думата",
    "The minimum amount of words that can be added to this field.":
      "Минималният брой думи, които могат да бъдат добавени към това поле.",
    "Maximum Word Length": "максимална дължина на думата",
    "The maximum amount of words that can be added to this field.":
      "Максималният брой думи, които могат да бъдат добавени към това поле.",
    "Regular Expression Pattern": "модел на регулярни изрази",
    "The regular expression pattern test that the field value must pass before the form can be submitted.":
      "Тест за модел на регулярен израз, който стойностите на полетата трябва да преминат, преди да бъде изпратен формулярът.",
    "Error Label": "грешен етикет",
    "The label for this field when an error occurs.":
      "Етикетът за това поле, когато е възникнала грешката.",
    "Custom Error Message": "персонализирано съобщение за грешка",
    "Error message displayed if any error occurred.":
      "Ако възникнат грешки, ще се покаже съобщение за грешка.",
    "Custom Validation": "персонализирано валидиране",
    "input": "въведете",
    "The value that was input into this component":
      "Въведете стойност за този компонент",
    "Enter custom validation code.":
      "Въведете персонализиран код за потвърждение.",
    "You must assign the valid variable as either true or an error message if validation fails.":
      "Въведете персонализиран код за потвърждение.",
    "Secret Validation": "тайна проверка",
    "Check this if you wish to perform the validation ONLY on the server side. This keeps your validation logic private and secret.":
      "Отметнете това, ако искате да извършите валидиране само от страна на сървъра. Това запазва вашата логика за валидиране поверителна и поверителна.",
    ...
    "The name of this field in the API endpoint.":
      "Името на това поле в крайната точка на API.",
    "Field Tags": "етикет на полето",
    "Tag the field for use in custom logic.":
      "Маркирайте полета за използване в персонализирана логика.",
    "Custom Properties": "персонализирани свойства",
    "This allows you to configure any custom properties for this component.":
      "Това ви позволява да конфигурирате всякакви персонализирани свойства за този компонент.",
    "Key": "ключ",
    "Value": "стойност",
    "Conditional": "Условно",
    "Simple": "просто",
    ...
    '"row", "data", and "component" variables are available. Return "result".':
      'Налични са променливи за ред, данни и компонент. Връща "резултат".',
    "Actions": "действие",
    "Action Name": "Име на действието",
    "Schema Defenition": "дефиниция на схемата",
    '"row", "data", "component", and "result" variables are available. Return the schema.':
      "Налични са променливи за ред, данни, компонент и резултат. Схема за връщане.",
    "Merge Component Schema": "Обединяване на архитектура на компонентите",
    "Custom Action": "персонализирано действие",
    "You must assign the show variable a boolean result.":
      "Трябва да присвоите булев резултат на променливата show.",
    "Note: Advanced Conditional logic will override the results of the Simple Conditional logic.":
      "Забележка: Разширената условна логика ще отмени резултата от проста условна логика.",
    "Example": "пример",
    '"row", "data", "component" and "_" variables are available. Return the result to be passed to the action if truthy.':
      'Налични са променливите "ред", "данни", "компонент" и "_". Ако е вярно, връща резултата, който трябва да бъде предаден на операцията.',
    "Add Action": "Добавете действие",
    "Save Logic": "запазете логиката",
    "Logic Name": "логическо име",
    "Event": "събитие",
    "The event that will trigger this logic. You can trigger events externally or via a button.":
      "Събитието, което ще задейства тази логика. Можете да задействате събития външно или чрез бутони.",
    ...
    "The settings inside apply only to the PDF forms.":
      "Настройките вътре важат само за PDF формуляри.",
    "PDF Overlay": "PDF наслагване",
    "Style": "стил",
    "Custom styles that should be applied to this component when rendered in PDF.":
      "Персонализирани стилове, които трябва да се прилагат към този компонент при изобразяване в PDF.",
    "Page": "Страница",
    "The PDF page to place this component.":
      "PDF страницата, където е поставен този компонент.",
    "Left": "остават",
    "The left margin within a page to place this component.":
      "Лявото поле на страницата, където е поставен този компонент.",
    "The top margin within a page to place this component.":
      "Горното поле на страницата, където е поставен този компонент.",
    "Width": "ширина",
    "The width of the component (in pixels).":
      "Ширината на компонента в пиксели.",
    "Height": "Високо",
    "The height of the component (in pixels).":
      "Височината на компонента в пиксели.",
    "Use Thousands Separator": "Използвайте разделител за хиляди",
    "Separate thousands by local delimiter.":
      "Разделете хиляди с локален разделител.",
    ...
    "Always show decimals, even if trailing zeros.":
      "Винаги показвайте десетични знаци, дори и с нули в края.",
    "Minimum Value": "минимум",
    "The minimum value this field must have before the form can be submitted.":
      "Минималната стойност, която това поле трябва да има, преди да изпратите формуляра.",
    "Maximum Value": "максимална стойност",
    "The maximum value this field can have before the form can be submitted.":
      "Максималната стойност, която това поле може да има преди изпращане на формуляра.",
    "Editor": "редактиране",
    "Select the type of WYSIWYG editor to use for this text area.":
      "Изберете типа WYSIWYG редактор, който да използвате за тази текстова област.",
    "ACE": "майстор",
    "Save As": "Запази като",
    "This setting determines how the value should be entered and stored in the database.":
      "Тази настройка определя как стойността трябва да бъде въведена и съхранена в базата данни.",
    "String": "низ",
    "JSON": "JSON",
    "Input Type": "тип вход",
    "This is the input type used for this checkbox.":
      "Това е типът на въвеждане, използван за това квадратче за отметка.",
    "Shortcut": "пряк път",
    "Shortcut for this component.": "Пряк път за този компонент.",
    "Password fields are automatically encrypted using 1-way salted bcrypt hashes. These hashes are also protected and not returned in the API.":
      "Полетата за парола се криптират автоматично с помощта на еднопосочен осолен bcrypt хеш. Тези хешове също са защитени от връщане в API.",
    "Options Label Position": "позиция на етикета на опцията",
    "Position for the label for options for this field.":
      "Местоположението на етикета на опцията за това поле.",
    "Right": "право",
    "Inline Layout": "вградено оформление",
    "Displays the checkboxes/radios horizontally.":
      "Показвайте хоризонтално квадратчетата за отметка/радио.",
    ...
    "Minimum checkboxes required before form can be submitted.":
      "Преди изпращане на формуляра са необходими минимални квадратчета за отметка.",
    "Maximum checked number": "Максимален брой проверки",
    "Maximum checkboxes possible before form can be submitted.":
      "Най-голямото възможно квадратче за отметка преди изпращане на формуляра.",
    "Minimum checked error message":
      "Съобщение за грешка при минимална проверка",
    "Error message displayed if minimum number of items not checked.":
      "Ако минималният брой елементи не е отметнат, се показва съобщение за грешка.",
    "Maximum checked error message":
      "съобщение за грешка при проверка на максималната стойност",
    "Error message displayed if maximum number of items checked.":
      "Ако е отметнат максималният брой елементи, ще се покаже съобщение за грешка.",
    "ChoicesJS": "изберете JS",
    "HTML 5": "HTML 5",
    "Unique Options": "уникален избор",
    "Display only unique dropdown options.":
      "Показват се само уникалните падащи опции.",
    "Data Source Type": "тип източник на данни",
    "The source to use for the select data. Values lets you provide your own values and labels. JSON lets you provide raw JSON data. URL lets you provide a URL to retrieve the JSON data from.":
      "Източникът, използван за избор на данните. Стойността ви позволява да предоставите своя собствена стойност и етикет. JSON ви позволява да предоставите необработени JSON данни. URL ви позволява да предоставите URL за извличане на JSON данни.",
    "Values": "стойности",
    ...
    "The type to store the data. If you select something other than autotype, it will force it to that type.":
      "Типът на съхраняваните данни. Ако изберете нещо различно от автоматично въвеждане, то ще го принуди да използва този тип.",
    "Autotype": "копие",
    "Boolean": "Булева стойност",
    "Object": "Предназначение",
    "ID Path": "Идентифицирайте пътя",
    "Path to the select option id.":
      "Изберете пътя за идентификатора на опцията.",
    "Table name": "Име на таблицата",
    "The name of table in the indexeddb database.":
      "Името на таблицата в базата данни indexeddb.",
    "Row Filter": "редов филтър",
    "Filter table items that match the object.":
      "Филтрирайте записи, които съответстват на обект.",
    "Item Template": "шаблон на артикул",
    "The HTML template for the result data items.":
      "HTML шаблон за получения елемент от данни.",
    "Enable Static Search ": "Активирайте статичното търсене",
    "When checked, the select dropdown will allow for searching within the static list of items provided.":
      "Когато е отметнато, падащото меню за избор ще позволи търсене в списъка с предоставени статични елементи.",
    "Search Threshold": "праг на търсене",
    "At what point does the match algorithm give up. A threshold of 0.0 requires a perfect match, a threshold of 1.0 would match anything.":
      "Кога алгоритъмът за съвпадение се отказва. Праг от 0.0 изисква перфектно съвпадение, праг от 1.0 отговаря на всичко.",
    "Read Only Value": "стойност само за четене",
    "Check this if you would like to show just the value when in Read Only mode.":
      "Отметнете това, ако искате да покажете стойността само в режим само за четене.",
    "Choices.js options": "Опции за Choices.js",
    "A raw JSON object to use as options for the Select component (Choices JS).":
      "Необработен JSON обект, използван като опции за Избор на компонент (Choices JS).",
    "Use exact search": "Използвайте точно търсене",
    "Disables search algorithm threshold.":
      "Деактивирайте праговете на алгоритъма за търсене.",
    "Theme": "тема",
    ...
    "This control should span the full width of the bounding container.":
      "Тази контрола трябва да обхваща цялата ширина на ограничаващия контейнер.",
    "Left Icon": "лява икона",
    "This is the full icon class string to show the icon.":
      "Това е пълният низ за клас на икона за показване на иконата. пример:",
    ...
    "This will disable this field if the form is invalid.":
      "Това ще деактивира това поле, ако формулярът е невалиден.",
    "Key topics for Sentiment Analysis":
      "Ключови теми в анализа на настроенията",
    "Enter topics to use in sentiment Analysis":
      "Въведете теми, които да използвате в анализа на настроенията",
    "Kickbox": "Таекуондо",
    "Enable": "активиране",
    "Enable Kickbox validation for this email field.":
      "Активирайте проверката на Kickbox за това поле за имейл.",
    "Validate this email using the Kickbox email validation service.":
      "Потвърдете този имейл с помощта на услугата за проверка на имейл Kickbox.",
    "Input Mask Placeholder Char":
      "символ на заместващ символ на маска за въвеждане",
    "Enable Manual Mode": "Активирайте ръчния режим",
    "Should Manual Mode be enabled for that component or not.":
      "Дали ръчният режим трябва да бъде активиран за този компонент.",
    "Switch To Manual Mode Label": "Превключете към раздела за ръчен режим",
    "The label for the checkbox used to switch to manual mode.":
      "Етикет за квадратчето за отметка, за да преминете към ръчен режим.",
    "Disable Clear Icon": "Деактивирайте иконата за изчистване",
    "Clear Icon allows easily clear components value.":
      "Иконата за изчистване улеснява изчистването на стойността на компонента.",
    "Provider": "доставчик",
    "Which address search service should be used.":
      "Коя услуга за търсене на адреси трябва да се използва.",
    ...
    "Use locale settings to display date and time.":
      "Показване на дата и час с помощта на локални настройки.",
    "Allow Manual Input": "Разрешете ръчно въвеждане",
    "Check this if you would like to allow the user to manually enter in the date.":
      "Поставете отметка в това, ако искате да позволите на потребителите да въвеждат ръчно дати.",
    "Format": "Форматиране",
    "The date format for displaying the datetime value.":
      "Форматът на датата, използван за показване на стойности за дата и час.",
    "Shortcut Buttons": "бутон за бърз достъп",
    "You can specify few buttons which will be shown above the calendar. Use Label to specify the name of the button and onClick to specify which date/time will be set when user clicks the button. ":
      "Можете да посочите няколко бутона, които ще се показват над календара. Използвайте Label, за да посочите името на бутона и onClick, за да посочите датата/часа, който ще бъде зададен, когато потребителят щракне върху бутона.",
    "onClick": "щракнете",
    "Enable Date Input": "Активирайте въвеждането на дата",
    "Enables date input for this field.":
      "Активирайте въвеждането на дата за това поле.",
    "Use Input to add moment.js for minDate":
      "Добавете moment.js за minDate с въвеждане",
    "Enables to use input for moment functions instead of calendar.":
      "Позволява въвеждането да се използва за времеви функции вместо за календари.",
    "Use calendar to set minDate": "Задайте minDate с помощта на календар",
    "Enables to use calendar to set date.":
      "Позволява използването на календар за задаване на дати.",
    "Use Input to add moment.js for maxDate":
      "Добавете moment.js за maxDate с въвеждане",
    "Use calendar to set maxDate": "Задайте maxDate с Календар",
    "Disable specific dates or dates by range":
      "Деактивирайте конкретни дати или дати по диапазон",
    "Add dates that you want to blacklist. For example:":
      "Добавете дати, които да бъдат в черния списък. Например:",
    "Custom Disabled Dates": "персонализирана дата за деактивиране",
    "date": "дата",
    "The date object.": "обект за дата.",
    "Data Format": "Формат на данни",
    "The moment.js format for saving the value of this field.":
      "Форматът moment.js, използван за запазване на стойността на това поле.",
    ...
    "Check to disable weekends":
      "Поставете отметка, за да деактивирате уикенда",
    "Check to disable weekdays":
      "Поставете отметка, за да деактивирате делничните дни",
    "Enable Time Input": "Активирайте въвеждането на време",
    "Enables time input for this field":
      "Активирайте въвеждането на време за това поле",
    "Hour Step Size": "Часова стъпка",
    "The number of hours to increment/decrement in the time picker.":
      "Часове за увеличаване/намаляване в инструмента за избор на време.",
    "Minute Step Size": "минута стъпка",
    "The number of minutes to increment/decrement in the time picker.":
      "Броят минути за увеличаване/намаляване в инструмента за избор на време.",
    "Display time in 12 hour time with AM/PM.":
      "Показва часа в AM/PM 12-часово време.",
    "12 Hour Time (AM/PM)": "12-часов часовник (AM/PM)",
    "Default Date": "дата по подразбиране",
    "You can use Moment.js functions to set the default value to a specific date. For example:":
      "Можете да използвате функциите Moment.js, за да зададете стойности по подразбиране на конкретни дати. Например:",
    ...
    "Attributes": "Атрибути",
    "The attributes for this HTML element. Only safe attributes are allowed, such as src, href, and title.":
      "Атрибути на този HTML елемент. Разрешени са само безопасни атрибути като src, href и title.",
    "Attribute": "Атрибути",
    "Refresh On Change": "освежете при промяна",
    "HTML Element": "HTML елемент",
    "Column Properties": "свойства на колоната",
    "The width, offset, push, and pull settings for each column.":
      "Настройки за ширина, изместване, натискане и изтегляне за всяка колона.",
    "Offset": "изместване",
    "Push": "натискам",
    "Pull": "дръпнете",
    "Auto adjust columns": "Автоматизирани колони",
    "Will automatically adjust columns based on if nested components are hidden.":
      "Колоната ще бъде автоматично коригирана в зависимост от това дали вложеният компонент е скрит или не.",
    "Hide Column when Children Hidden":
      "Скриване на колоните, когато децата са скрити",
    "Check this if you would like to hide any column when the children within that column are also hidden":
      "Отметнете това, ако искате да скриете колона, когато децата в тази колона също са скрити",
    "Legend": "легенда",
    "The legend for this Fieldset.": "Легендата за този набор от полета.",
    "Default": "по подразбиране",
    "Collapsible": "сгъваем",
    "If checked, this will turn this Panel into a collapsible panel.":
      "Ако е отметнато, това ще превърне този панел в сгъваем панел.",
    "Number of Rows": "Редове",
    "Enter the number or rows that should be displayed by this table.":
      "Въведете броя или броя на редовете, които тази таблица трябва да показва.",
    "Number of Columns": "брой колони",
    "Enter the number or columns that should be displayed by this table.":
      "Въведете числата или колоните, които тази таблица трябва да показва.",
    ...
    "Horizontal alignment for cells of the table.":
      "Хоризонтално подравняване на клетките на таблицата. заедно",
    "Center": "център",
    "Striped": "райе",
    "This will stripe the table if checked.":
      "Ако е отметнато, това ще очертае масата.",
    "Bordered": "граничеща",
    "This will border the table if checked.":
      "Ако е отметнато, това ще активира границите на таблицата.",
    "Hover": "скитащи се",
    ...
    "Provide a label text for Key column (otherwise Key will be used)":
      "Предоставете текста на етикета за колоната Ключ (в противен случай ще се използва „Ключ“)",
    "Disable Adding / Removing Rows":
      "Деактивирайте добавянето/изтриването на редове",
    "Check if you want to hide Add Another button and Remove Row button":
      "Проверете дали искате да скриете добавяне на друг бутон и изтриване на бутони за редове",
    "Show key column before value":
      "Показване на ключовата колона преди стойността",
    "Check if you would like to show the Key before the Value column.":
      "Отметнете дали искате да покажете ключа преди колоната Стойност.",
    "Type of event": "вид дейност",
    "Specify type of event that this reCAPTCHA would react to":
      "Определя типа събития, на които ще реагира това reCAPTCHA",
    "Form Load": "зареждане на формуляра",
    "Button Click": "щракване върху бутона",
    "The form to load within this form component.":
      "Формулярът за зареждане в този компонент на формуляр.",
    "Form Revision": "Ревизия на формуляра",
    "You can lock the nested form to a specific revision by entering the revision number here.":
      "Можете да заключите вложен формуляр към конкретна ревизия, като въведете номера на ревизията тук.",
    "Use Original Revision while Submissions Viewing":
      "Използвайте оригиналната ревизия, когато преглеждате комита",
    "Using this option will make form load the original revision (the one which was used to make a submission) when viewing a submission.":
      "Използването на тази опция ще накара формуляра да зареди оригиналната ревизия (ревизия за подаване) при преглед на подаването.",
    "Save as reference": "Запазване като справка",
    "Using this option will save this field as a reference and link its value to the value of the origin record.":
      "Използването на тази опция запазва това поле като препратка и свързва стойността му със стойността на оригиналния запис.",
    "Select Fields": "изберете поле",
    "The properties on the resource to return as part of the options. If left blank, all properties will be returned.":
      "Свойства на ресурса, върнати като част от опции. Ако се остави празно, всички свойства ще бъдат върнати.",
    "Search Fields": "поле за търсене",
    "Filter Query": "филтърна заявка",
    "Use this to provide additional filtering using query parameters.":
      "Използвайте това, за да осигурите допълнително филтриране с помощта на параметри на заявката.",
    "The filter query for results.": "Резултатът от заявката за филтър.",
    "Sort Query": "Заявка за сортиране",
    "Use this to provide additional sorting using query parameters":
      "Използвайте това, за да осигурите допълнително сортиране с помощта на параметри на заявката",
    "The sort query for results": "Заявка за сортиране за резултати",
    "Add Resource": "Добавете ресурси",
    "Allows to create a new resource while entering a submission.":
      "Позволява създаване на нови ресурси при въвеждане на запис.",
  ...
  pt: {
    ...
    "No submission avaliable in the selected date. Please select another date range":
      "Nenhuma submissão disponível na data selecionada. Selecione outro intervalo de datas",
    "All groups have access to the dashboard":
    ...
    "Add form fields to display in task list":
      "Adicionar campos de formulário para exibir na lista de tarefas",
    "Version": "Versão",
    ...
    "Ok": "OK",
    "No submissions available for the selected date range":
      "Nenhum envio disponível para o período selecionado",
    ...
    "Associate this form with a workflow?":
      "Associar este formulário a um fluxo de trabalho?",
    ...
    "Premium": "Prêmio",
    "Drag and Drop a form component":
      "Arraste e solte um componente de formulário",
    "Preview": "Visualizar",
    "The minimum length requirement this field must meet.":
      "O requisito de comprimento mínimo que este campo deve atender.",
    "Label": "Etiqueta",
    "The label for this field that will appear next to it.":
      "O rótulo para este campo que aparecerá ao lado dele.",
    "Label Position": "Posição do rótulo",
    "Position for the label for this field.":
      "Posição do rótulo para este campo.",
    "Placeholder": "Espaço reservado",
    "The placeholder text that will appear when this field is empty.":
      "O texto do espaço reservado que aparecerá quando este campo estiver vazio.",
    "Description": "Descrição",
    "The description is text that will appear below the input field.":
      "A descrição é um texto que aparecerá abaixo do campo de entrada.",
    "Tooltip": "Dica de ferramenta",
    "Adds a tooltip to the side of this field.":
      "Adiciona uma dica de ferramenta ao lado deste campo.",
    "To add a tooltip to this field, enter text here.":
      "Para adicionar uma dica de ferramenta a este campo, digite o texto aqui.",
    "Description for this field.": "Descrição para este campo.",
    "Prefix": "Prefixo",
    "Suffix": "Sufixo",
    "Widget": "Ferramenta",
    "The widget is the display UI used to input the value of the field.":
      "O widget é a interface do usuário de exibição usada para inserir o valor do campo.",
    ...
    "The width of label on line in percentages.":
      "A largura do rótulo na linha em porcentagens.",
    "Label Margin": "Margem do rótulo",
    "The width of label margin on line in percentages.":
      "A largura da margem do rótulo na linha em porcentagens.",
    "Rows": "Linhas",
    ...
    "Custom CSS class to add to this component.":
      "Classe CSS personalizada para adicionar a este componente.",
    "Tab Index": "Índice da guia",
    "Sets the tabindex attribute of this component to override the tab order of the form. See the MDN documentation on tabindex for more information.":
      "Define o atributo tabindex deste componente para substituir a ordem de tabulação do formulário. Consulte a documentação do MDN no tabindex para obter mais informações.",
    "Autocomplete": "autocompletar",
    "Indicates whether input elements can by default have their values automatically completed by the browser. See the MDN documentation on autocomplete for more information.":
      "Indica se os elementos de entrada podem, por padrão, ter seus valores preenchidos automaticamente pelo navegador. Consulte a documentação do MDN sobre preenchimento automático para obter mais informações.",
    "A hidden field is still a part of the form, but is hidden from view.":
      "Um campo oculto ainda faz parte do formulário, mas fica oculto.",
    "Hide Label": "Ocultar etiqueta",
    "Show Word Counter": "Mostrar contador de palavras",
    "Show a live count of the number of words.":
      "Mostrar uma contagem ao vivo do número de palavras.",
    "Hide the label (title, if no label) of this component. This allows you to show the label in the form builder, but not when it is rendered.":
      "Oculte o rótulo (título, se não houver rótulo) deste componente. Isso permite que você mostre o rótulo no construtor de formulários, mas não quando ele é renderizado.",
    "Show Character Counter": "Mostrar contador de caracteres",
    "Show a live count of the number of characters.":
      "Mostrar uma contagem ao vivo do número de caracteres.",
    "Hide Input": "Ocultar entrada",
    "Hide the input in the browser. This does not encrypt on the server. Do not use for passwords.":
      "Oculte a entrada no navegador. Isso não criptografa no servidor. Não use para senhas.",
    "Initial Focus": "Foco inicial",
    "Make this field the initially focused element on this form.":
      "Faça deste campo o elemento inicialmente focado neste formulário.",
    ...
    "Shows this value within the table view of the submissions.":
      "Mostra esse valor na exibição de tabela dos envios.",
    "Modal Edit": "Edição Modal",
    "Opens up a modal to edit the value of this component.":
      "Abre um modal para editar o valor deste componente.",
    "Multiple Values": "Vários valores",
    "Allows multiple values to be entered for this field.":
      "Permite que vários valores sejam inseridos para este campo.",
    "Default Value": "Valor padrão",
    "The will be the value for this field, before user interaction. Having a default value will override the placeholder text.":
      "O será o valor para este campo, antes da interação do usuário. Ter um valor padrão substituirá o texto do espaço reservado.",
    "Persistent": "Persistente",
    "A persistent field will be stored in database when the form is submitted.":
      "Um campo persistente será armazenado no banco de dados quando o formulário for enviado.",
    "None": "Nenhum",
    "Server": "Servidora",
    "Client": "Cliente",
    "Input Format": "Formato de entrada",
    "Force the output of this field to be sanitized in a specific format.":
      "Força a saída deste campo a ser higienizada em um formato específico.",
    "Plain": "Plana",
    "Type to search": "Escreva para pesquisar",
    "Raw (Insecure)": "Bruto (inseguro)",
    "Protected": "Protegida",
    "A protected field will not be returned when queried via API.":
      "Um campo protegido não será retornado quando consultado via API.",
    "Database Index": "Índice do banco de dados",
    "Set this field as an index within the database. Increases performance for submission queries.":
      "Defina este campo como um índice no banco de dados. Aumenta o desempenho para consultas de envio.",
    "Text Case": "Caixa de texto",
    "When data is entered, you can change the case of the value.":
      "Quando os dados são inseridos, você pode alterar as maiúsculas e minúsculas do valor.",
    "Mixed (Allow upper and lower case)":
      "Misto (Permitir maiúsculas e minúsculas)",
    "Uppercase": "Maiúsculas",
    "Lowercase": "Minúsculas",
    "Encrypted (Enterprise Only)": "Criptografado (somente Enterprise)",
    "Encrypt this field on the server. This is two way encryption which is not suitable for passwords.":
      "Criptografe este campo no servidor. Esta é uma criptografia bidirecional que não é adequada para senhas.",
    "Redraw On": "Redesenhado em",
    "Redraw this component if another component changes. This is useful if interpolating parts of the component like the label.":
      "Redesenhe este componente se outro componente for alterado. Isso é útil ao interpolar partes do componente como o rótulo.",
    "Any Change": "Qualquer mudança",
    "Clear Value When Hidden": "Limpar valor quando oculto",
    "When a field is hidden, clear the value.":
      "Quando um campo estiver oculto, limpe o valor.",
    "The following variables are available in all scripts.":
      "As seguintes variáveis ​​estão disponíveis em todos os scripts.",
    ...
    "data": "dadas",
    "The complete submission data object.":
      "O objeto de dados de envio completo.",
    "row": "fileira",
    'Contextual "row" data, used within DataGrid, EditGrid, and Container components':
      'Dados de "linha" contextuais, usados ​​nos componentes DataGrid, EditGrid e Container',
    "component": "component",
    ...
    "moment": "momento",
    "The moment.js library for date manipulation.":
      "A biblioteca moment.js para manipulação de datas.",
    "utils": "útil",
    "util": "útil",
    'An alias for "utils".': 'Um alias para "utils".。',
    "JavaScript": "JavaScript",
    "Enter custom javascript code.":
      "Insira o código javascript personalizado.",
    "Example:": "Exemplo:",
    "JSONLogic": "JSONLogic",
    "Execute custom logic using ": "Execute a lógica personalizada usando",
    'support is provided using an "_" before each operation, such as {"_sum": {var: "data.a"}}':
      'o suporte é fornecido usando um "_" antes de cada operação, como {"_sum": {var: "data.a"}}',
    "Full": "Completa",
    "Calculated Value": "Valor calculado",
    "token": "símbolo",
    "The decoded JWT token for the authenticated user.":
      "O token JWT decodificado para o usuário autenticado.",
    "Calculate Value on server": "Calcular valor no servidor",
    "Checking this will run the calculation on the server. This is useful if you wish to override the values submitted with the calculations performed on the server.":
      "Marcar isso executará o cálculo no servidor. Isso é útil se você deseja substituir os valores enviados pelos cálculos realizados no servidor.",
    "Allow Manual Override of Calculated Value":
      "Permitir substituição manual do valor calculado",
    "When checked, this will allow the user to manually override the calculated value.":
      "Quando marcado, isso permitirá que o usuário substitua manualmente o valor calculado.",
    "Save": "Salve ",
    "Remove": "Remover",
    "Validate On": "Validar em",
    "Determines when this component should trigger front-end validation.":
      "Determina quando esse componente deve acionar a validação de front-end.",
    "Change": "Mudar",
    "Blur": "Borrão",
    "Required": "Requeridos",
    "A required field must be filled in before the form can be submitted.":
      "Um campo obrigatório deve ser preenchido antes que o formulário possa ser enviado.",
    "Unique": "Única",
    "Makes sure the data submitted for this field is unique, and has not been submitted before.":
      "Garante que os dados enviados para este campo sejam exclusivos e não tenham sido enviados antes.",
    "Minimum Length": "Comprimento mínimo",
    "The maximum length requirement this field must meet.":
      "O requisito de comprimento máximo que este campo deve atender.",
    "Maximum Length": "Comprimento máximo",
    "Minimum Word Length": "Comprimento Mínimo da Palavra",
    "The minimum amount of words that can be added to this field.":
      "A quantidade mínima de palavras que podem ser adicionadas a este campo.",
    "Maximum Word Length": "Comprimento Máximo da Palavra",
    "The maximum amount of words that can be added to this field.":
      "A quantidade máxima de palavras que podem ser adicionadas a este campo.",
    "Regular Expression Pattern": "Padrão de Expressão Regular",
    "The regular expression pattern test that the field value must pass before the form can be submitted.":
      "O teste padrão de expressão regular que o valor do campo deve passar antes que o formulário possa ser enviado.",
    "Error Label": "Etiqueta de erro",
    "The label for this field when an error occurs.":
      "O rótulo para este campo quando ocorre um erro.",
    "Custom Error Message": "Mensagem de erro personalizada",
    "Error message displayed if any error occurred.":
      "Mensagem de erro exibida se ocorrer algum erro.",
    "Custom Validation": "Validação personalizada",
    "input": "entrada",
    "The value that was input into this component":
      "O valor que foi inserido neste componente",
    "Enter custom validation code.":
      "Insira o código de validação personalizado.",
    "You must assign the valid variable as either true or an error message if validation fails.":
      "Você deve atribuir a variável válida como verdadeira ou uma mensagem de erro se a validação falhar.",
    "Secret Validation": "Validação secreta",
    "Check this if you wish to perform the validation ONLY on the server side. This keeps your validation logic private and secret.":
      "Marque isso se desejar realizar a validação SOMENTE no lado do servidor. Isso mantém sua lógica de validação privada e secreta.",
    ...
    "The name of this field in the API endpoint.":
      "O nome desse campo no endpoint da API.",
    "Field Tags": "Tags de campo",
    "Tag the field for use in custom logic.":
      "Marque o campo para uso na lógica personalizada.",
    "Custom Properties": "Propriedades personalizadas",
    "This allows you to configure any custom properties for this component.":
      "Isso permite configurar quaisquer propriedades personalizadas para este componente.",
    "Key": "Chave",
    ...
    '"row", "data", and "component" variables are available. Return "result".':
      'As variáveis ​​"linha", "dados" e "componente" estão disponíveis. Retorna "resultado".',
    "Actions": "Ações",
    "Action Name": "Nome da ação",
    "Property": "Propriedade",
    "Schema Defenition": "Definição do Esquema",
    '"row", "data", "component", and "result" variables are available. Return the schema.':
      'As variáveis ​​"linha", "dados", "componente" e "resultado" estão disponíveis. Devolva o esquema.',
    "Merge Component Schema": "Mesclar Esquema de Componente",
    "Custom Action": "Ação personalizada",
    "You must assign the show variable a boolean result.":
      "Você deve atribuir à variável show um resultado booleano.",
    "Note: Advanced Conditional logic will override the results of the Simple Conditional logic.":
      "Observação: a lógica condicional avançada substituirá os resultados da lógica condicional simples.",
    "Example": "Exemplo",
    '"row", "data", "component" and "_" variables are available. Return the result to be passed to the action if truthy.':
      'As variáveis ​​"row", "data", "component" e "_" estão disponíveis. Retorna o resultado a ser passado para a ação se for verdadeiro.',
    "Add Action": "Adicionar ação",
    "Save Logic": "Salvar lógica",
    "Logic Name": "Nome lógico",
    "Event": "Evento",
    "The event that will trigger this logic. You can trigger events externally or via a button.":
      "O evento que acionará essa lógica. Você pode acionar eventos externamente ou por meio de um botão.",
    ...
    "The settings inside apply only to the PDF forms.":
      "As configurações internas se aplicam apenas aos formulários PDF.",
    "PDF Overlay": "Sobreposição de PDF",
    "Style": "Estilo",
    "Custom styles that should be applied to this component when rendered in PDF.":
      "Estilos personalizados que devem ser aplicados a este componente quando renderizados em PDF.",
    "Page": "Página",
    "The PDF page to place this component.":
      "A página PDF para colocar este componente.",
    "Left": "Esquerda",
    "The left margin within a page to place this component.":
      "A margem esquerda dentro de uma página para colocar este componente.",
    "The top margin within a page to place this component.":
      "A margem superior dentro de uma página para colocar este componente.。",
    "Width": "Largura",
    "The width of the component (in pixels).":
      "A largura do componente (em pixels).",
    "Height": "Altura",
    "The height of the component (in pixels).":
      "A altura do componente (em pixels).",
    "Use Thousands Separator": "Use o separador de milhares",
    "Separate thousands by local delimiter.":
      "Separe milhares por delimitador local.",
    "Decimal Places": "Casas decimais",
    "The maximum number of decimal places.":
      "O número máximo de casas decimais.",
    "Require Decimal": "Exigir Decimal",
    "Always show decimals, even if trailing zeros.":
      "Sempre mostre decimais, mesmo se zeros à direita.",
    "Minimum Value": "Valor mínimo",
    "The minimum value this field must have before the form can be submitted.":
      "O valor mínimo que este campo deve ter antes que o formulário possa ser enviado.",
    "Maximum Value": "Valor máximo",
    "The maximum value this field can have before the form can be submitted.":
      "O valor máximo que este campo pode ter antes que o formulário possa ser enviado.",
    "Editor": "Editora",
    "Select the type of WYSIWYG editor to use for this text area.":
      "Selecione o tipo de editor WYSIWYG a ser usado para esta área de texto.",
    "ACE": "ÁS",
    "Save As": "Salvar como",
    "This setting determines how the value should be entered and stored in the database.":
      "Essa configuração determina como o valor deve ser inserido e armazenado no banco de dados.",
    "String": "Corda",
    "JSON": "JSON",
    "Input Type": "Tipo de entrada",
    "This is the input type used for this checkbox.":
      "Este é o tipo de entrada usado para esta caixa de seleção.",
    "Shortcut": "Atalho",
    "Shortcut for this component.": "Atalho para este componente.",
    "Password fields are automatically encrypted using 1-way salted bcrypt hashes. These hashes are also protected and not returned in the API.":
      "Os campos de senha são criptografados automaticamente usando hashes bcrypt salgados unidirecionais. Esses hashes também são protegidos e não são retornados na API.",
    "Options Label Position": "Posição do rótulo de opções",
    "Position for the label for options for this field.":
      "Posição para o rótulo de opções para este campo.",
    "Right": "Certa",
    "Inline Layout": "Layout embutido",
    "Displays the checkboxes/radios horizontally.":
      "Exibe as caixas de seleção/rádios horizontalmente.",
    "Allow only available values": "Permitir apenas valores disponíveis",
    "Minimum checked number": "Número mínimo verificado",
    "Minimum checkboxes required before form can be submitted.":
      "Caixas de seleção mínimas necessárias antes que o formulário possa ser enviado.",
    "Maximum checked number": "Número máximo verificado",
    "Maximum checkboxes possible before form can be submitted.":
      "Máximo de caixas de seleção possíveis antes que o formulário possa ser enviado.",
    "Minimum checked error message": "Mensagem de erro mínima verificada",
    "Error message displayed if minimum number of items not checked.":
      "Mensagem de erro exibida se o número mínimo de itens não for verificado.",
    "Maximum checked error message": "Máximo de mensagens de erro verificadas",
    "Error message displayed if maximum number of items checked.":
      "Mensagem de erro exibida se o número máximo de itens for verificado.",
    "ChoicesJS": "ChoicesJS",
    "HTML 5": "HTML 5",
    "Unique Options": "Opções únicas",
    "Display only unique dropdown options.":
      "Exiba apenas opções de lista suspensa exclusivas.",
    "Data Source Type": "Tipo de fonte de dados",
    "The source to use for the select data. Values lets you provide your own values and labels. JSON lets you provide raw JSON data. URL lets you provide a URL to retrieve the JSON data from.":
      "fonte a ser usada para os dados selecionados. Valores permite que você forneça seus próprios valores e rótulos. JSON permite fornecer dados JSON brutos. URL permite que você forneça um URL para recuperar os dados JSON.",
    "Values": "Valores",
    "Raw JSON": "JSON bruto",
    "IndexedDB": "BD indexado",
    "Database name": "Nome do banco de dados",
    "The name of the indexeddb database.":
      "O nome do banco de dados indexeddb.",
    "Storage Type": "Tipo de armazenamento",
    "The type to store the data. If you select something other than autotype, it will force it to that type.":
      "O tipo para armazenar os dados. Se você selecionar algo diferente de autotype, ele o forçará a esse tipo.",
    "Autotype": "Autotipo",
    "Boolean": "boleano",
    "Object": "Objeto",
    ...
    "The name of table in the indexeddb database.":
      "O nome da tabela no banco de dados indexeddb.",
    "Row Filter": "Filtro de linha",
    "Filter table items that match the object.":
      "Filtre os itens da tabela que correspondem ao objeto.",
    "Item Template": "Modelo de item",
    "The HTML template for the result data items.":
      "O modelo HTML para os itens de dados de resultado.",
    "Enable Static Search ": "Ativar pesquisa estática",
    "When checked, the select dropdown will allow for searching within the static list of items provided.":
      "Quando marcada, a lista suspensa de seleção permitirá a pesquisa na lista estática de itens fornecidos.",
    "Search Threshold": "Limite de pesquisa",
    "At what point does the match algorithm give up. A threshold of 0.0 requires a perfect match, a threshold of 1.0 would match anything.":
      "Em que ponto o algoritmo de correspondência desiste. Um limite de 0,0 requer uma correspondência perfeita, um limite de 1,0 corresponderia a qualquer coisa.",
    "Read Only Value": "Valor somente leitura",
    "Check this if you would like to show just the value when in Read Only mode.":
      "Marque isso se você quiser mostrar apenas o valor quando estiver no modo Somente leitura.",
    "Choices.js options": "Opções de Choices.js",
    "A raw JSON object to use as options for the Select component (Choices JS).":
      "Um objeto JSON bruto para usar como opções para o componente Select (Choices JS).",
    "Use exact search": "Usar pesquisa exata",
    "Disables search algorithm threshold.":
      "Desativa o limite do algoritmo de pesquisa.",
    "Theme": "Tema",
    ...
    "This control should span the full width of the bounding container.":
      "Esse controle deve abranger toda a largura do contêiner delimitador.",
    "Left Icon": "Ícone esquerdo",
    "This is the full icon class string to show the icon.":
      "Esta é a string de classe de ícone completa para mostrar o ícone.",
    "Right Icon": "Ícone direito",
    "This is the full icon class string to show the icon. Example:":
      "Esta é a string de classe de ícone completa para mostrar o ícone. Exemplo:",
    "Primary": "Primária",
    ...
    "This will disable this field if the form is invalid.":
      "Isso desativará este campo se o formulário for inválido.",
    "Key topics for Sentiment Analysis":
      "Tópicos-chave para Análise de Sentimentos",
    "Enter topics to use in sentiment Analysis":
      "Insira os tópicos a serem usados ​​na Análise de sentimento",
    "Kickbox": "Kickbox",
    "Enable": "Habilitar",
    "Enable Kickbox validation for this email field.":
      "Habilite a validação Kickbox para este campo de e-mail.",
    "Validate this email using the Kickbox email validation service.":
      "Valide este e-mail usando o serviço de validação de e-mail Kickbox.",
    "Input Mask Placeholder Char":
      "Caractere de espaço reservado para máscara de entrada",
    "Enable Manual Mode": "Ativar modo manual",
    "Should Manual Mode be enabled for that component or not.":
      "O modo manual deve estar habilitado para esse componente ou não.",
    "Switch To Manual Mode Label": "Mudar para o rótulo do modo manual",
    "The label for the checkbox used to switch to manual mode.":
      "O rótulo da caixa de seleção usada para alternar para o modo manual.",
    "Disable Clear Icon": "Desativar ícone Limpar",
    "Clear Icon allows easily clear components value.":
      "Clear Icon permite limpar facilmente o valor dos componentes.",
    "Provider": "Fornecedor",
    "Which address search service should be used.":
      "Qual serviço de pesquisa de endereços deve ser usado.",
    ...
    "The maximum amount of tags that can be added. 0 for infinity.":
      "A quantidade máxima de tags que podem ser adicionadas. 0 para infinito.",
    ...
    "This will display the captured date time in the select timezone.":
      "Isso exibirá a data e hora capturada no fuso horário selecionado.",
    ...
    "Use locale settings to display date and time.":
      "Use as configurações de localidade para exibir data e hora.",
    "Allow Manual Input": "Permitir entrada manual",
    "Check this if you would like to allow the user to manually enter in the date.":
      "Marque esta opção se desejar permitir que o usuário insira manualmente a data.",
    "Format": "Formato",
    "The date format for displaying the datetime value.":
      "O formato de data para exibir o valor de data e hora.",
    "Shortcut Buttons": "Botões de atalho",
    "You can specify few buttons which will be shown above the calendar. Use Label to specify the name of the button and onClick to specify which date/time will be set when user clicks the button. ":
      "Você pode especificar alguns botões que serão mostrados acima do calendário. Use Label para especificar o nome do botão e onClick para especificar qual data/hora será definida quando o usuário clicar no botão.",
    "onClick": "ao clicar",
    "Enable Date Input": "Ativar entrada de data",
    "Enables date input for this field.":
      "Habilita a entrada de data para este campo.",
    "Use Input to add moment.js for minDate":
      "Use Input para adicionar moment.js para minDate",
    "Enables to use input for moment functions instead of calendar.":
      "Permite usar entrada para funções de momento em vez de calendário.",
    "Use calendar to set minDate": "Use o calendário para definir minDate",
    "Enables to use calendar to set date.":
      "Permite usar o calendário para definir a data.",
    "Use Input to add moment.js for maxDate":
      "Use Input para adicionar moment.js para maxDate",
    "Use calendar to set maxDate": "Use o calendário para definir maxDate",
    "Disable specific dates or dates by range":
      "Desativar datas ou datas específicas por intervalo",
    "Add dates that you want to blacklist. For example:":
      "Adicione datas que você deseja colocar na lista negra. Por exemplo:",
    "Custom Disabled Dates": "Datas de desativação personalizadas",
    "date": "encontro",
    "The date object.": "O objeto de data.",
    "Data Format": "Formato de dados",
    "The moment.js format for saving the value of this field.":
      "O formato moment.js para salvar o valor deste campo.",
    ...
    "Enables time input for this field":
      "Habilita a entrada de tempo para este campo",
    "Hour Step Size": "Tamanho do passo de hora",
    "The number of hours to increment/decrement in the time picker.":
      "O número de horas para incrementar/diminuir no seletor de tempo.",
    "Minute Step Size": "Tamanho do Passo Minuto",
    "The number of minutes to increment/decrement in the time picker.":
      "O número de minutos para incrementar/diminuir no seletor de tempo.",
    "Display time in 12 hour time with AM/PM.":
      "Exibe o tempo em 12 horas com AM/PM.",
    "12 Hour Time (AM/PM)": "Horário de 12 horas (AM/PM)",
    "Default Date": "Data padrão",
    "You can use Moment.js functions to set the default value to a specific date. For example:":
      "Você pode usar as funções Moment.js para definir o valor padrão para uma data específica. Por exemplo:",
    ...
    "The attributes for this HTML element. Only safe attributes are allowed, such as src, href, and title.":
      "Os atributos para este elemento HTML. Apenas atributos seguros são permitidos, como src, href e title.",
    "Attribute": "Atributo",
    "Refresh On Change": "Atualizar na mudança",
    "HTML Element": "Elemento HTML",
    "Column Properties": "Propriedades da coluna",
    "The width, offset, push, and pull settings for each column.":
      "As configurações de largura, deslocamento, empurrar e puxar para cada coluna.",
    "Offset": "Desvio",
    "Push": "Empurre",
    "Pull": "Puxar",
    "Auto adjust columns": "Colunas de ajuste automático",
    "Will automatically adjust columns based on if nested components are hidden.":
      "Ajustará automaticamente as colunas com base se os componentes aninhados estiverem ocultos.",
    "Hide Column when Children Hidden":
      "Ocultar coluna quando os filhos estiverem ocultos",
    "Check this if you would like to hide any column when the children within that column are also hidden":
      "Assinale isto se desejar ocultar alguma coluna quando os filhos dessa coluna também estiverem ocultos",
    "Legend": "Lenda",
    "The legend for this Fieldset.": "A legenda para este Fieldset.",
    "Default": "Padrão",
    "Collapsible": "Dobrável",
    "If checked, this will turn this Panel into a collapsible panel.":
      "Se marcado, isso transformará este Painel em um painel dobrável.",
    "Number of Rows": "Numero de linhas",
    "Enter the number or rows that should be displayed by this table.":
      "Insira o número ou as linhas que devem ser exibidas por esta tabela.",
    "Number of Columns": "Numero de colunas",
    "Enter the number or columns that should be displayed by this table.":
      "Insira o número ou colunas que devem ser exibidas por esta tabela.",
    ...
    "Horizontal alignment for cells of the table.":
      "Alinhamento horizontal para células da tabela.",
    "Center": "Centro",
    "Striped": "Listrado",
    "This will stripe the table if checked.":
      "Isso irá riscar a tabela se estiver marcado.",
    "Bordered": "Delimitada",
    "This will border the table if checked.":
      "Isso fará a borda da tabela se estiver marcado.",
    "Hover": "Flutuar",
    ...
    "Provide a label text for Key column (otherwise Key will be used)":
      "Forneça um texto de rótulo para a coluna Chave (caso contrário, a chave será usada)",
    "Disable Adding / Removing Rows": "Desativar adição/remoção de linhas",
    "Check if you want to hide Add Another button and Remove Row button":
      "Verifique se você deseja ocultar o botão Adicionar outro e o botão Remover linha",
    "Show key column before value": "Mostrar coluna chave antes do valor",
    "Check if you would like to show the Key before the Value column.":
      "Verifique se você gostaria de mostrar a Chave antes da coluna Valor.",
    "Type of event": "Tipo de evento",
    "Specify type of event that this reCAPTCHA would react to":
      "Especifique o tipo de evento ao qual este reCAPTCHA reagiria",
    "Form Load": "Carregamento de formulário",
    "Button Click": "Clique no botão",
    "Form": "Forma",
    "The form to load within this form component.":
      "O formulário a ser carregado nesse componente de formulário.",
    "Form Revision": "Revisão do formulário",
    "You can lock the nested form to a specific revision by entering the revision number here.":
      "Você pode bloquear o formulário aninhado para uma revisão específica inserindo o número da revisão aqui.",
    "Use Original Revision while Submissions Viewing":
      "Use a revisão original durante a visualização de envios",
    "Using this option will make form load the original revision (the one which was used to make a submission) when viewing a submission.":
      "Usar esta opção fará com que o formulário carregue a revisão original (a que foi usada para fazer um envio) ao visualizar um envio.",
    "Save as reference": "Salvar como referência",
    "Using this option will save this field as a reference and link its value to the value of the origin record.":
      "O uso desta opção salvará este campo como referência e vinculará seu valor ao valor do registro de origem.",
    "Select Fields": "Selecionar campos",
    "The properties on the resource to return as part of the options. If left blank, all properties will be returned.":
      "As propriedades no recurso a serem retornadas como parte das opções. Se deixado em branco, todas as propriedades serão retornadas.",
    "Search Fields": "Campos de pesquisa",
    "Filter Query": "Filtrar consulta",
    "Use this to provide additional filtering using query parameters.":
      "Use isso para fornecer filtragem adicional usando parâmetros de consulta.",
    "The filter query for results.": "A consulta de filtro para resultados.",
    "Sort Query": "Classificar consulta",
    "Use this to provide additional sorting using query parameters":
      "Use isso para fornecer classificação adicional usando parâmetros de consulta",
    "The sort query for results": "A consulta de classificação para resultados",
    "Add Resource": "Adicionar recurso",
    "Allows to create a new resource while entering a submission.":
      "Permite criar um novo recurso ao inserir um envio.",
    "Add Resource Label": "Adicionar rótulo de recurso",
    "Set the text of the Add Resource button.":
      "Defina o texto do botão Adicionar recurso.",
    ...
    "Edit": "Editar",
    "Do you want to associate form with a workflow ?":
      "Você deseja associar o formulário a um fluxo de trabalho?",
    "Yes": "sim",
    "No": "Não",
    "Form Name": "Nome do formulario ",
    "Workflow Name": "Nome do fluxo de trabalho",
    "Publish this form for Client Users.":
      "Publique este formulário para usuários clientes.",
    "Comments": "Comentários",
    "Back": "Voltar",
    "Edit Form": "Editar Formulário",
    "Next": "Próxima",
    "Are you sure you wish to delete this submission?":
      "Tem certeza de que deseja excluir este envio?",
    ...
    "Please change the selected filters to view tasks":
      "Por favor, mude os filtros selecionados para ver as tarefas",
    ...
    "value": "valor",
    "No task matching filters found.":
      "Nenhum filtro de correspondência de tarefa encontrado.",
    ...
    "You can add a group by typing a group ID into the input field and afterwards clicking the button with the plus sign.":
      "Você pode adicionar um grupo digitando um ID de grupo no campo de entrada e, em seguida, clicando no botão com o sinal de mais.",
    ...
    "Failed": "Fracassada",
    "Press Enter key or click here to search":
      "Pressione a tecla Enter ou clique aqui para pesquisar",
  ...
  fr: {
    ...
    "No submission avaliable in the selected date. Please select another date range":
      "Aucune soumission disponible à la date sélectionnée. Veuillez sélectionner une autre plage de dates",
    "All groups have access to the dashboard":
    ...
    "Add form fields to display in task list":
      "Ajouter des champs de formulaire à afficher dans la liste des tâches",
    "Version": "Version",
    ...
    "Ok": "D'accord",
    "No submissions available for the selected date range":
      "Aucune soumission disponible pour la plage de dates sélectionnée",
    "Save Form": "Enregistrer le formulaire",
    "Confirm": "Confirmer",
    "Cancel": "Annuler",
    "Wizard": "Magier",
    "Please fix the errors before submitting again.":
      "Veuillez corriger les erreurs avant de soumettre à nouveau.",
    ...
    "Drag and Drop a form component":
      "Glisser-déposer des composants de formulaire",
    "Preview": "Aperçu",
    "The minimum length requirement this field must meet.":
      "Exigences de longueur minimale que ce champ doit respecter",
    "Label": "Étiquette",
    "The label for this field that will appear next to it.":
      "L'étiquette qui apparaîtra à côté de ce champ.",
    "Label Position": "position de l'étiquette",
    "Position for the label for this field.":
      "La position de l'étiquette pour ce champ.",
    "Placeholder": "Remplacer",
    "The placeholder text that will appear when this field is empty.":
      "Placez le texte à afficher lorsque ce champ est vide.",
    "Description": "décris",
    "The description is text that will appear below the input field.":
      "La description est le texte qui apparaîtra sous le champ de saisie.",
    "Tooltip": "indice",
    "Adds a tooltip to the side of this field.":
      "Ajoutez une info-bulle sur le côté de ce champ.",
    "To add a tooltip to this field, enter text here.":
      "Pour ajouter un indice à ce champ, saisissez du texte ici.",
    "Description for this field.": "Description de ce champ.",
    "Prefix": "préfixe",
    "Suffix": "extension",
    "Widget": "petits outils",
    "The widget is the display UI used to input the value of the field.":
      "Le widget est une interface utilisateur sur l'écran pour entrer des valeurs de champ.",
    ...
    "The width of label on line in percentages.":
      "La largeur de l'étiquette en ligne (en pourcentage).",
    "Label Margin": "Champ de rubrique",
    "The width of label margin on line in percentages.":
      "Largeur de ligne de l'étiquette de ligne, exprimée en pourcentage.",
    "Rows": "Éd",
    ...
    "Custom CSS class to add to this component.":
      "Classe CSS personnalisée à ajouter à ce composant.",
    "Tab Index": "Index des marqueurs",
    "Sets the tabindex attribute of this component to override the tab order of the form. See the MDN documentation on tabindex for more information.":
      "Définissez la propriété tabindex de ce composant pour annuler l'ordre des sections du formulaire. Voir la documentation tabindex MDN pour plus d'informations.",
    "Autocomplete": "Saisie automatique",
    "Indicates whether input elements can by default have their values automatically completed by the browser. See the MDN documentation on autocomplete for more information.":
      "ndique si l'élément d'entrée peut compléter automatiquement sa valeur à partir du navigateur par défaut. Pour plus d'informations, consultez la documentation MDN de l'unité semi-automatique.",
    "A hidden field is still a part of the form, but is hidden from view.":
      "Les champs masqués font toujours partie du formulaire, mais sont masqués.",
    "Hide Label": "Section cachée",
    "Show Word Counter": "Afficher le compteur de mots",
    "Show a live count of the number of words.":
      "Affiche le nombre de mots en temps réel.",
    "Hide the label (title, if no label) of this component. This allows you to show the label in the form builder, but not when it is rendered.":
      "Cachez l'étiquette (titre si pas d'étiquette) pour ce composant. Cela vous permet d'afficher l'étiquette dans le concepteur de formulaire, mais pas lorsqu'elle est affichée",
    "Show Character Counter": "Afficher le compteur de caractères",
    "Show a live count of the number of characters.":
      "Affiche le nombre de caractères en temps réel.",
    "Hide Input": "entrée cachée",
    "Hide the input in the browser. This does not encrypt on the server. Do not use for passwords.":
      "Masquer l'entrée du navigateur. Ce n'est pas crypté sur le serveur. Ne pas utiliser pour les mots de passe.",
    "Initial Focus": "mise au point initial",
    "Make this field the initially focused element on this form.":
      "Faites de ce champ l'élément ciblé initialement dans ce formulaire.",
    ...
    "Shows this value within the table view of the submissions.":
      "Affichez cette valeur dans la vue de tableau soumise.",
    "Modal Edit": "Édition modale",
    "Opens up a modal to edit the value of this component.":
      "Ouvre un programme modal pour modifier la valeur de ce composant.",
    "Multiple Values": "ensemble de valeurs",
    "Allows multiple values to be entered for this field.":
      "Plusieurs valeurs sont autorisées pour ce champ.",
    "Default Value": "Défaut",
    "The will be the value for this field, before user interaction. Having a default value will override the placeholder text.":
      "sera la valeur de ce champ avant d'interagir avec l'utilisateur. Avoir une valeur par défaut remplacera le texte de remplacement.",
    "Persistent": "permanent",
    "A persistent field will be stored in database when the form is submitted.":
      "Les champs permanents seront stockés dans la base de données lors de la soumission du formulaire.",
    "None": "Pas tout le monde",
    "Server": "serveur",
    "Client": "client",
    "Input Format": "format d'entrée",
    "Force the output of this field to be sanitized in a specific format.":
      "Force la sortie de ce champ à être désinfectée dans un certain format.",
    "Plain": "dégager",
    "Type to search": "entrer une recherche",
    "Raw (Insecure)": "cru (dangereux)",
    "Protected": "protégé",
    "A protected field will not be returned when queried via API.":
      "Les champs protégés ne sont pas retournés sur demande via l'API.",
    "Database Index": "indice de base de données",
    "Set this field as an index within the database. Increases performance for submission queries.":
      "Définissez ce champ comme un index dans la base de données. Améliorer l'efficacité des requêtes envoyées.",
    "Text Case": "cas de texte",
    "When data is entered, you can change the case of the value.":
      "Lorsque vous saisissez des données, vous pouvez modifier le registre de valeurs maître.",
    "Mixed (Allow upper and lower case)": "mixte (cas autorisés)",
    "Uppercase": "Capitale",
    "Lowercase": "minuscules",
    "Encrypted (Enterprise Only)": "Chiffrement (Entreprise uniquement)",
    "Encrypt this field on the server. This is two way encryption which is not suitable for passwords.":
      "Ce champ est chiffré sur le serveur. Il s'agit d'un cryptage bidirectionnel, qui ne convient pas aux mots de passe.",
    "Redraw On": "redessiner",
    "Redraw this component if another component changes. This is useful if interpolating parts of the component like the label.":
      "Si un autre composant change, redessinez ce composant. Ceci est utile lors de l'insertion de parties de composants telles que des étiquettes.",
    "Any Change": "Tout changement",
    "Clear Value When Hidden": "Effacer la valeur lorsqu'elle est masquée",
    "When a field is hidden, clear the value.":
      "Lorsque le champ est masqué, effacez la valeur.",
    "The following variables are available in all scripts.":
      "Les variables suivantes sont disponibles dans tous les scripts.",
    ...
    "data": "Les données",
    "The complete submission data object.":
      "L'objet complet avec les données de soumission.",
    "row": "Éd",
    'Contextual "row" data, used within DataGrid, EditGrid, and Container components':
      'Données contextuelles "lignes" utilisées dans les composants DataGrid, EditGrid et Container',
    "component": "Composants",
    ...
    "moment": "moment",
    "The moment.js library for date manipulation.":
      "Bibliothèque moment.js pour manipuler les dates.",
    "utils": "utilitaire",
    "util": "utilitaire",
    ...
    "Execute custom logic using ":
      "Exécuter une logique personnalisée à l'aide de",
    'support is provided using an "_" before each operation, such as {"_sum": {var: "data.a"}}':
      'Utilisez "_" avant chaque opération pour fournir un support, par ex. {"_sum": {var : "data.a"}}',
    "Full": "complet",
    "Calculated Value": "Calculé",
    "token": "jeton",
    "The decoded JWT token for the authenticated user.":
      "La balise JWT décodée de l'utilisateur authentifié.",
    "Calculate Value on server": "Calculer la valeur du serveur",
    "Checking this will run the calculation on the server. This is useful if you wish to override the values submitted with the calculations performed on the server.":
      "Cochez cette case pour démarrer le calcul du serveur. Ceci est utile si vous souhaitez remplacer la valeur soumise par un calcul effectué sur le serveur.",
    "Allow Manual Override of Calculated Value":
      "Autoriser l'annulation manuelle des valeurs calculées",
    "When checked, this will allow the user to manually override the calculated value.":
      "Lorsqu'elle est cochée, cela permettra à l'utilisateur d'annuler manuellement la valeur calculée.",
    "Save": "sauver",
    "Remove": "suppression",
    "Validate On": "L'authentification est activée",
    "Determines when this component should trigger front-end validation.":
      "Détermine quand ce composant doit déclencher une vérification d'interface.",
    "Change": "Changer",
    "Blur": "Pas clair",
    "Required": "obligatoire",
    "A required field must be filled in before the form can be submitted.":
      "Les champs obligatoires doivent être remplis avant que le formulaire puisse être envoyé.",
    "Unique": "Unique",
    "Makes sure the data submitted for this field is unique, and has not been submitted before.":
      "Assurez-vous que les données soumises pour ce champ sont uniques et n'ont pas été soumises auparavant.",
    "Minimum Length": "Longueur minimale",
    "The maximum length requirement this field must meet.":
      "L'exigence de longueur maximale que ce champ doit respecter.",
    "Maximum Length": "Longueur maximale",
    "Minimum Word Length": "Longueur minimale des mots",
    "The minimum amount of words that can be added to this field.":
      "Le nombre minimum de mots pouvant être ajoutés à ce champ.",
    ...
    "The regular expression pattern test that the field value must pass before the form can be submitted.":
      "Testez un modèle d'expression régulière que les valeurs de champ doivent passer avant que le formulaire ne soit soumis.",
    "Error Label": "mauvaise étiquette",
    "The label for this field when an error occurs.":
      "Libellé de ce champ lorsque l'erreur s'est produite.",
    "Custom Error Message": "message d'erreur personnalisé",
    "Error message displayed if any error occurred.":
      "Si des erreurs se produisent, un message d'erreur s'affiche.",
    "Custom Validation": "validation personnalisée",
    "input": "Entrer",
    "The value that was input into this component":
      "Entrez une valeur pour ce composant",
    "Enter custom validation code.":
      "Entrez un code de vérification personnalisé.",
    "You must assign the valid variable as either true or an error message if validation fails.":
      "Entrez un code de vérification personnalisé.",
    "Secret Validation": "chèque secret",
    "Check this if you wish to perform the validation ONLY on the server side. This keeps your validation logic private and secret.":
      "Cochez cette case si vous souhaitez effectuer une validation serveur uniquement. Cela permet de garder votre logique de validation confidentielle et confidentielle.",
    ...
    "The name of this field in the API endpoint.":
      "Le nom de ce champ au point de terminaison de l'API.",
    "Field Tags": "étiquette de champ",
    "Tag the field for use in custom logic.":
      "Cochez les champs à utiliser dans la logique personnalisée.",
    "Custom Properties": "propriétés personnalisées",
    "This allows you to configure any custom properties for this component.":
      "Cela vous permet de configurer toutes les propriétés personnalisées pour ce composant.",
    "Key": "clé",
    "Value": "valeur",
    ...
    '"row", "data", and "component" variables are available. Return "result".':
      'Des variables pour la ligne, les données et le composant sont disponibles. Renvoie le "résultat".',
    "Actions": "action",
    "Action Name": "Nom de l'action",
    "Property": "Propriété",
    "Schema Defenition": "définition du régime",
    '"row", "data", "component", and "result" variables are available. Return the schema.':
      "Des variables pour l'ordre, les données, le composant et le résultat sont disponibles. Régime de retour.",
    "Merge Component Schema": "Combiner l'architecture des composants",
    "Custom Action": "action personnalisée",
    "You must assign the show variable a boolean result.":
      "Vous devez affecter un résultat booléen à la variable show.",
    "Note: Advanced Conditional logic will override the results of the Simple Conditional logic.":
      "Remarque : La logique conditionnelle avancée remplacera le résultat de la logique conditionnelle simple.",
    "Example": "Exemple",
    '"row", "data", "component" and "_" variables are available. Return the result to be passed to the action if truthy.':
      "Les variables 'ligne',' données',' composante 'et' _ sont disponibles. Si c'est le cas, renvoyez le résultat à l'opération.",
    "Add Action": "Ajouter une action",
    "Save Logic": "garder la logique",
    "Logic Name": "nom logique",
    "Event": "un évènement",
    "The event that will trigger this logic. You can trigger events externally or via a button.":
      "L'événement qui déclenchera cette logique. Vous pouvez déclencher des événements en externe ou via des boutons.",
    ...
    "The settings inside apply only to the PDF forms.":
      "Les paramètres à l'intérieur s'appliquent uniquement aux formulaires PDF.",
    "PDF Overlay": "Superposition PDF",
    "Style": "style",
    "Custom styles that should be applied to this component when rendered in PDF.":
      "Styles personnalisés à appliquer à ce composant lors de l'affichage au format PDF.",
    "Page": "Page",
    "The PDF page to place this component.":
      "La page PDF où ce composant est placé.",
    "Left": "rester",
    "The left margin within a page to place this component.":
      "La marge gauche de la page où ce composant est placé.",
    "The top margin within a page to place this component.":
      "Le champ supérieur de la page où ce composant est placé.",
    "Width": "largeur",
    "The width of the component (in pixels).":
      "La largeur du composant en pixels.",
    "Height": "Haut",
    "The height of the component (in pixels).":
      "La hauteur du composant en pixels.",
    "Use Thousands Separator": "Utiliser un séparateur de milliers",
    "Separate thousands by local delimiter.":
      "Divisez les milliers par le séparateur local.",
    ...
    "Always show decimals, even if trailing zeros.":
      "Affichez toujours les décimales, même avec des zéros à la fin.",
    "Minimum Value": "le minimum",
    "The minimum value this field must have before the form can be submitted.":
      "La valeur minimale que ce champ doit avoir avant de soumettre le formulaire.",
    "Maximum Value": "valeur maximum",
    "The maximum value this field can have before the form can be submitted.":
      "La valeur maximale que ce champ peut avoir avant de soumettre le formulaire.",
    "Editor": "montage",
    "Select the type of WYSIWYG editor to use for this text area.":
      "Sélectionnez le type d'éditeur WYSIWYG à utiliser pour cette zone de texte.",
    "ACE": "Maître",
    "Save As": "Enregistrer sous",
    "This setting determines how the value should be entered and stored in the database.":
      "Ce paramètre détermine comment la valeur doit être entrée et stockée dans la base de données.",
    "String": "chaîne de caractères",
    "JSON": "JSON",
    "Input Type": "type d'entrée",
    "This is the input type used for this checkbox.":
      "Il s'agit du type d'entrée utilisé pour cette case à cocher.",
    "Shortcut": "raccourci",
    ...
    "Position for the label for options for this field.":
      "L'emplacement de l'étiquette d'option pour ce champ.",
    "Right": "à droite",
    "Inline Layout": "mise en page intégrée",
    "Displays the checkboxes/radios horizontally.":
      "Afficher les cases radio / radio horizontalement.",
    "Allow only available values":
      "Seules les valeurs disponibles sont autorisées",
    "Minimum checked number": "Nombre minimal d'inspections",
    "Minimum checkboxes required before form can be submitted.":
      "Un minimum de cases à cocher est requis avant de soumettre le formulaire.",
    "Maximum checked number": "Nombre maximal d'inspections",
    "Maximum checkboxes possible before form can be submitted.":
      "La plus grande case à cocher possible avant de soumettre le formulaire.",
    "Minimum checked error message":
      "Message d'erreur de vérification minimale",
    "Error message displayed if minimum number of items not checked.":
      "Si le nombre minimum d'éléments n'est pas coché, un message d'erreur s'affiche.",
    "Maximum checked error message":
      "message d'erreur lors de la vérification de la valeur maximale",
    "Error message displayed if maximum number of items checked.":
      "Si le nombre maximum d'éléments est coché, un message d'erreur s'affichera.",
    "ChoicesJS": "sélectionnez JS",
    "HTML 5": "HTML 5",
    "Unique Options": "choix unique",
    "Display only unique dropdown options.":
      "Seules les options déroulantes uniques sont affichées.",
    "Data Source Type": "type de source de données",
    "The source to use for the select data. Values lets you provide your own values and labels. JSON lets you provide raw JSON data. URL lets you provide a URL to retrieve the JSON data from.":
      "La source utilisée pour sélectionner les données. La valeur vous permet de fournir votre propre valeur et étiquette. JSON vous permet de fournir des données JSON brutes. URL vous permet de fournir une URL pour récupérer les données JSON.",
    "Values": "valeurs",
    "Raw JSON": "JSON brut",
    "IndexedDB": "base de données d'index",
    "Database name": "Base de données de noms",
    "The name of the indexeddb database.":
      "Le nom de la base de données est indexeddb.",
    "Storage Type": "type de stockage",
    "The type to store the data. If you select something other than autotype, it will force it to that type.":
      "Le type de données stockées. Si vous choisissez autre chose que la saisie automatique, cela l'obligera à utiliser ce type.",
    "Autotype": "copie",
    ...
    "The name of table in the indexeddb database.":
      "Le nom de la table dans la base de données indexeddb.",
    "Row Filter": "filtre en ligne",
    "Filter table items that match the object.":
      "Filtrez les enregistrements qui correspondent à un objet.",
    "Item Template": "modèle d'article",
    "The HTML template for the result data items.":
      "Modèle HTML pour l'élément de données résultant.",
    "Enable Static Search ": "Activer la recherche statique",
    "When checked, the select dropdown will allow for searching within the static list of items provided.":
      "Lorsqu'il est coché, le menu déroulant permet de rechercher dans la liste des éléments statiques fournis.",
    "Search Threshold": "seuil de recherche",
    "At what point does the match algorithm give up. A threshold of 0.0 requires a perfect match, a threshold of 1.0 would match anything.":
      "Lorsque l'algorithme de correspondance échoue. Un seuil de 0,0 nécessite une correspondance parfaite, un seuil de 1,0 répond à tout.",
    "Read Only Value": "valeur en lecture seule",
    "Check this if you would like to show just the value when in Read Only mode.":
      "Cochez cette case si vous souhaitez afficher la valeur en mode lecture seule.",
    "Choices.js options": "Options de Choices.js",
    "A raw JSON object to use as options for the Select component (Choices JS).":
      "Objet JSON brut utilisé comme options de sélection de composants (Choices JS).",
    "Use exact search": "Utiliser une recherche précise",
    "Disables search algorithm threshold.":
      "Désactivez les seuils de l'algorithme de recherche.",
    "Theme": "sujet",
    ...
    "This control should span the full width of the bounding container.":
      "Ce contrôle doit couvrir toute la largeur du conteneur de contention.",
    "Left Icon": "icône de gauche",
    "This is the full icon class string to show the icon.":
      "l s'agit de la chaîne complète de la classe d'icônes pour afficher l'icône. Exemple:",
    "Right Icon": "icône de droite",
    "This is the full icon class string to show the icon. Example:":
      "Il s'agit de la chaîne complète de la classe d'icônes pour afficher l'icône. Exemple:",
    "Primary": "de base",
    "Secondary": "lycée",
    "Info": "information",
    ...
    "Disable on Form Invalid":
      "Le formulaire de désactivation ne fonctionne pas",
    "This will disable this field if the form is invalid.":
      "Cela désactivera ce champ si le formulaire n'est pas valide.",
    "Key topics for Sentiment Analysis": "Thèmes clés de l'analyse de l'humeur",
    "Enter topics to use in sentiment Analysis":
      "Entrez les sujets à utiliser dans l'analyse de l'humeur",
    "Kickbox": "Taekwondo",
    "Enable": "Activation",
    "Enable Kickbox validation for this email field.":
      "Activez la vérification de Kickbox pour ce champ d'e-mail.",
    "Validate this email using the Kickbox email validation service.":
      "Confirmez cet e-mail avec le service de vérification des e-mails Kickbox.",
    "Input Mask Placeholder Char":
      "symbole de remplacement du masque de saisie",
    "Enable Manual Mode": "Activer le mode manuel",
    "Should Manual Mode be enabled for that component or not.":
      "Indique si le mode manuel doit être activé pour ce composant.",
    "Switch To Manual Mode Label": "Passer à l'onglet du mode manuel",
    "The label for the checkbox used to switch to manual mode.":
      "Cochez la case pour passer en mode manuel. Pour le mode manuel",
    "Disable Clear Icon":
      "Désactiver l'icône d'effacement du mode manuel pour le mode manuel",
    "Clear Icon allows easily clear components value.":
      "L'icône d'effacement permet d'effacer facilement la valeur du composant.",
    "Provider": "fournisseur",
    "Which address search service should be used.":
      "Quel service de recherche d'adresse doit être utilisé.",
    "Manual Mode View String": "Afficher les chaînes en mode manuel",
    "Specify template which should be when quering view string for the component value entered in manual mode. This string is used in table view, CSV export and email rendering. When left blank combined value of all components joined with comma will be used.":
      "Spécifie le modèle à utiliser lors de l'interrogation des chaînes de vue pour les valeurs de composant saisies en mode manuel. Cette chaîne est utilisée pour l'affichage du tableau, l'exportation CSV et l'affichage des e-mails. Lorsqu'il est laissé vide, la valeur combinée de tous les composants liés à la virgule sera utilisée.",
    ...
    "What is used to separate the tags.":
      "Ce qui est utilisé pour séparer les étiquettes.",
    "Max Tags": "max. étiquette",
    "The maximum amount of tags that can be added. 0 for infinity.":
      "Le nombre maximum de balises pouvant être ajoutées. 0 signifie infini.",
    ...
    "This will display the captured date time in the select timezone.":
      "Cela affichera la date et l'heure capturées dans le fuseau horaire sélectionné.",
    ...
    "Use locale settings to display date and time.":
      "Afficher la date et l'heure à l'aide des paramètres locaux.",
    "Allow Manual Input": "Autoriser la saisie manuelle",
    "Check this if you would like to allow the user to manually enter in the date.":
      "Cochez cette case si vous souhaitez autoriser les utilisateurs à entrer des dates manuellement.",
    "Format": "Mise en page",
    "The date format for displaying the datetime value.":
      "Format de date utilisé pour afficher les valeurs de date et d'heure.",
    "Shortcut Buttons": "bouton de raccourci",
    "You can specify few buttons which will be shown above the calendar. Use Label to specify the name of the button and onClick to specify which date/time will be set when user clicks the button. ":
      "Vous pouvez spécifier plusieurs boutons qui seront affichés au-dessus du calendrier. Utilisez Label pour spécifier le nom du bouton et onClick pour spécifier la date/l'heure qui sera définie lorsque l'utilisateur cliquera sur le bouton.",
    "onClick": "Cliquez sur",
    "Enable Date Input": "Activer la saisie de date",
    "Enables date input for this field.":
      "Activer la saisie de date pour ce champ.",
    "Use Input to add moment.js for minDate":
      "Ajoutez moment.js à minDate au fur et à mesure que vous tapez",
    "Enables to use input for moment functions instead of calendar.":
      "Permet d'utiliser l'entrée pour les fonctions temporelles au lieu des calendriers.",
    "Use calendar to set minDate": "Définir minDate à l'aide d'un calendrier",
    "Enables to use calendar to set date.":
      "Vous permet d'utiliser un calendrier pour définir des dates",
    "Use Input to add moment.js for maxDate":
      "Ajouter moment.js pour maxDate avec entrée",
    "Use calendar to set maxDate": "Définir maxDate avec le calendrier",
    "Disable specific dates or dates by range":
      "Désactiver des dates spécifiques ou des dates par plage",
    "Add dates that you want to blacklist. For example:":
      "Ajoutez des dates à mettre sur liste noire. Par example:",
    "Custom Disabled Dates": "date de désactivation personnalisée",
    "date": "Date",
    "The date object.": "objet pour la date.",
    "Data Format": "Format de données",
    "The moment.js format for saving the value of this field.":
      "Le format moment.js utilisé pour conserver la valeur de ce champ.",
    ...
    "Check to disable weekdays":
      "Cochez pour désactiver les jours de la semaine",
    "Enable Time Input": "Активирайте въвеждането на време",
    "Enables time input for this field":
      "Activer la saisie de temps pour ce champ",
    "Hour Step Size": "Pas horaire",
    "The number of hours to increment/decrement in the time picker.":
      "Augmenter / diminuer les heures dans l'outil de sélection de temps.",
    "Minute Step Size": "petit pas",
    "The number of minutes to increment/decrement in the time picker.":
      "Le nombre de minutes à augmenter/diminuer dans l'outil de sélection de temps.",
    "Display time in 12 hour time with AM/PM.":
      "Affiche l'heure en AM/PM sur 12 heures.",
    "12 Hour Time (AM/PM)": "Horloge de 12 heures (AM / PM)",
    "Default Date": "date par défaut",
    "You can use Moment.js functions to set the default value to a specific date. For example:":
      "Vous pouvez utiliser les fonctions Moment.js pour définir des valeurs par défaut pour des dates spécifiques. Par example:",
    ...
    "The attributes for this HTML element. Only safe attributes are allowed, such as src, href, and title.":
      "Attributs de cet élément HTML. Seuls les attributs sécurisés tels que src, href et title sont autorisés.",
    "Attribute": "Attribut",
    "Refresh On Change": "rafraîchir lors du changement",
    "HTML Element": "élément HTML",
    "Column Properties": "propriétés de la colonne",
    "The width, offset, push, and pull settings for each column.":
      "Paramètres de largeur, de décalage, de poussée et de glissement pour chaque colonne.",
    "Offset": "déplacement",
    "Push": "j'appuie",
    "Pull": "tirer",
    "Auto adjust columns": "Colonnes automatisées",
    "Will automatically adjust columns based on if nested components are hidden.":
      "La colonne sera automatiquement ajustée selon que le composant inséré est masqué ou non.",
    "Hide Column when Children Hidden":
      "Masquer les colonnes lorsque les enfants sont masqués",
    "Check this if you would like to hide any column when the children within that column are also hidden":
      "Cochez cette case si vous souhaitez masquer une colonne lorsque les enfants de cette colonne sont également masqués",
    "Legend": "Légende",
    "The legend for this Fieldset.": "La légende de cet ensemble de champs.",
    "Default": "défaut",
    "Collapsible": "pliant",
    "If checked, this will turn this Panel into a collapsible panel.":
      "Si coché, cela transformera ce panneau en un panneau pliable.",
    "Number of Rows": "Lignes",
    "Enter the number or rows that should be displayed by this table.":
      "Saisissez le nombre ou le nombre de lignes que ce tableau doit afficher.",
    "Number of Columns": "le nombre de colonnes",
    "Enter the number or columns that should be displayed by this table.":
      "Entrez les nombres ou les colonnes que ce tableau doit afficher.",
    ...
    "Horizontal alignment for cells of the table.":
      "Alignement horizontal des cellules du tableau. ensemble",
    "Center": "centre",
    "Striped": "paradis",
    "This will stripe the table if checked.":
      "Si cette case est cochée, cela décrira le tableau.",
    "Bordered": "en bordure",
    "This will border the table if checked.":
      "Si coché, cela activera les limites de la table.",
    "Hover": "errant",
    "Highlight a row on hover.":
      "Mettez une ligne en surbrillance lorsque vous maintenez le curseur.",
    "Condensed": "concentré",
    "Condense the size of the table.": "La taille de la masse comprimée.",
    "Label for Key column": "étiquette de la colonne clé",
    "Provide a label text for Key column (otherwise Key will be used)":
      "Fournissez le texte de l'étiquette pour la colonne Clé (sinon 'Clé' sera utilisé)",
    "Disable Adding / Removing Rows":
      "Désactiver l'ajout/la suppression de lignes",
    "Check if you want to hide Add Another button and Remove Row button":
      "Assurez-vous que vous souhaitez masquer l'ajout d'un autre bouton et la suppression des boutons de ligne",
    "Show key column before value": "Afficher la colonne clé avant la valeur",
    "Check if you would like to show the Key before the Value column.":
      "Indiquez si vous souhaitez afficher la clé avant la colonne Valeur.",
    "Type of event": "type d'activité",
    "Specify type of event that this reCAPTCHA would react to":
      "Spécifie le type d'événements auxquels ce reCAPTCHA répondra",
    "Form Load": "chargement du formulaire",
    "Button Click": "cliquez sur le bouton",
    "Form": "former",
    "The form to load within this form component.":
      "Le formulaire de chargement dans ce composant de formulaire.",
    "Form Revision": "Révision du formulaire",
    "You can lock the nested form to a specific revision by entering the revision number here.":
      "Vous pouvez verrouiller un formulaire joint à une révision spécifique en entrant le numéro de révision ici.",
    "Use Original Revision while Submissions Viewing":
      "Utilisez la révision originale lors de la consultation du comité",
    "Using this option will make form load the original revision (the one which was used to make a submission) when viewing a submission.":
      "L'utilisation de cette option entraînera le chargement de la révision d'origine (révision de la soumission) lors de la révision de la soumission.",
    "Save as reference": "Запазване като справка",
    "Using this option will save this field as a reference and link its value to the value of the origin record.":
      "L'utilisation de cette option enregistre ce champ en tant que référence et associe sa valeur à la valeur de l'enregistrement d'origine.",
    "Select Fields": "изберете поле",
    "The properties on the resource to return as part of the options. If left blank, all properties will be returned.":
      "Propriétés de ressource renvoyées dans le cadre des options. Si laissé vide, toutes les propriétés seront restaurées.",
    "Search Fields": "Barre de recherche",
    "Filter Query": "demande de filtre",
    "Use this to provide additional filtering using query parameters.":
      "Utilisez ceci pour fournir un filtrage supplémentaire à l'aide de paramètres de requête.",
    "The filter query for results.": "Le résultat de la demande de filtre.",
    "Sort Query": "Demande de tri",
    "Use this to provide additional sorting using query parameters":
      "Utilisez ceci pour fournir un tri supplémentaire à l'aide des paramètres de requête",
    "The sort query for results": "Trier la requête pour les résultats",
    "Add Resource": "Ajouter des ressources",
    "Allows to create a new resource while entering a submission.":
      "Permet de créer de nouvelles ressources lors de la saisie d'un enregistrement.",
    "Add Resource Label": "Ajouter des balises de ressources",
    "Set the text of the Add Resource button.":
      "Définit le texte du bouton Ajouter une ressource.",
    ...
    "All steps completed - you're finished":
      "Toutes les étapes terminées - vous avez terminé",
    "Are you sure you wish to delete the form":
      "Êtes-vous sûr de vouloir supprimer le formulaire",
    "Edit": "Éditer",
    "Do you want to associate form with a workflow ?":
      "Vous souhaitez associer un formulaire à un workflow ?",
    "Yes": "Oui",
    "No": "Non",
    "Form Name": "Nom de forme ",
    "Workflow Name": "Nom du flux de travail ",
    "Publish this form for Client Users.":
      "Publiez ce formulaire pour les utilisateurs clients.",
    ...
    "Please change the selected filters to view tasks":
      "Veuillez modifier les filtres sélectionnés pour afficher les tâches",
    ...
    "name": "Nom",
    "No task matching filters found.":
      "Aucun filtre de correspondance de tâche trouvé.",
    ...
    "You can add a group by typing a group ID into the input field and afterwards clicking the button with the plus sign.":
      "Vous pouvez ajouter un groupe en saisissant un identifiant de groupe dans le champ de saisie, puis en cliquant sur le bouton avec le signe plus.",
    ...
    "Press Enter key or click here to search":
    "Appuyez sur la touche Entrée ou cliquez ici pour rechercher",
  ...
  de: {
    ...
    "All groups have access to the dashboard":
      "Alle Gruppen haben Zugriff auf das Dashboard",
    "Form unpublishing Failed":
    ...
    "Workflow Name": "Workflow-Name",
    "Publish this form for Client Users.":
      "Veröffentlichen Sie dieses Formular für Clientbenutzer.",
    ...
    "Please change the selected filters to view tasks":
      "Bitte ändern Sie die ausgewählten Filter, um Aufgaben anzuzeigen",
    ...
    "For Variable, ignore case of":
      "Ignorieren Sie für Variable die Groß- und Kleinschreibung",
    "name": "Name",
    "value": "Wert",
    "No Filters Found":
    ...
    "The placeholder text that will appear when this field is empty.":
      "Der Platzhaltertext, der angezeigt wird, wenn dieses Feld leer ist.",
    "The description is text that will appear below the input field.":
    ...
    "Widget": "Widget",
    "The widget is the display UI used to input the value of the field.":
      "Das Widget ist die Anzeige-UI, die verwendet wird, um den Wert des Felds einzugeben.",
    ...
    "Custom CSS class to add to this component.":
      "Benutzerdefinierte CSS-Klasse, die dieser Komponente hinzugefügt werden soll.",
    "Tab Index": "Tab-Index",
    "Sets the tabindex attribute of this component to override the tab order of the form. See the MDN documentation on tabindex for more information.":
      "Legt das tabindex-Attribut dieser Komponente fest, um die Tab-Reihenfolge des Formulars zu überschreiben. Weitere Informationen finden Sie in der MDN-Dokumentation auf tabindex.",
    ...
    "Make this field the initially focused element on this form.":
      "Machen Sie dieses Feld zum anfänglich fokussierten Element in diesem Formular.",
    ...
    "Shows this value within the table view of the submissions.":
      "Zeigt diesen Wert in der Tabellenansicht der Übermittlungen an.",
    "Modal Edit": "Modale Bearbeitung",
    "Opens up a modal to edit the value of this component.":
      "Öffnet ein Modal zum Bearbeiten des Werts dieser Komponente.",
    "Multiple Values": "Mehrere Werte",
    "Allows multiple values to be entered for this field.":
      "Ermöglicht die Eingabe mehrerer Werte für dieses Feld.",
    ...
    "Force the output of this field to be sanitized in a specific format.":
      "Erzwingen Sie, dass die Ausgabe dieses Felds in einem bestimmten Format bereinigt wird.",
    "Plain": "Einfach",
    "Type to search": "Tippe um zu suchen",
    "Raw (Insecure)": "Roh (unsicher)",
    "Protected": "gesichert",
    "A protected field will not be returned when queried via API.":
      "Ein geschütztes Feld wird nicht zurückgegeben, wenn es über die API abgefragt wird.",
    "Database Index": "Datenbankindex",
    "Set this field as an index within the database. Increases performance for submission queries.":
      "Legen Sie dieses Feld als Index innerhalb der Datenbank fest. Erhöht die Leistung für Übermittlungsabfragen.",
    "Text Case": "Textfall",
    "When data is entered, you can change the case of the value.":
      "Wenn Daten eingegeben werden, können Sie die Groß-/Kleinschreibung des Werts ändern.",
    "Mixed (Allow upper and lower case)":
      "Gemischt (Groß- und Kleinschreibung zulassen)",
    ...
    "When a field is hidden, clear the value.":
      "Wenn ein Feld ausgeblendet ist, löschen Sie den Wert.",
    "The following variables are available in all scripts.":
    ...
    "token": "Zeichen",
    "The decoded JWT token for the authenticated user.":
      "Das entschlüsselte JWT-Token für den authentifizierten Benutzer.",
    "Calculate Value on server": "Wert auf dem Server berechnen",
    "Checking this will run the calculation on the server. This is useful if you wish to override the values submitted with the calculations performed on the server.":
      "Wenn Sie dies aktivieren, wird die Berechnung auf dem Server ausgeführt. Dies ist nützlich, wenn Sie die übermittelten Werte mit den auf dem Server durchgeführten Berechnungen überschreiben möchten.",
    "Allow Manual Override of Calculated Value":
      "Manuelles Überschreiben des berechneten Werts zulassen",
    "When checked, this will allow the user to manually override the calculated value.":
    ...
    "The minimum amount of words that can be added to this field.":
      "Die Mindestanzahl an Wörtern, die diesem Feld hinzugefügt werden können.",
    "Maximum Word Length": "Maximale Wortlänge",
    "The maximum amount of words that can be added to this field.":
      "Die maximale Anzahl an Wörtern, die diesem Feld hinzugefügt werden können.",
    ...
    "Enter custom validation code.":
      "Geben Sie einen benutzerdefinierten Validierungscode ein.",
    "You must assign the valid variable as either true or an error message if validation fails.":
      "Sie müssen die gültige Variable entweder als wahr oder als Fehlermeldung zuweisen, wenn die Validierung fehlschlägt.",
    ...
    "This component should Display:":
      "Diese Komponente sollte Folgendes anzeigen:",
    "True": "Wahr",
    "False": "Falsch",
    ...
    '"row", "data", "component", and "result" variables are available. Return the schema.':
      'Die Variablen "row", "data", "component" und "result" sind verfügbar. Geben Sie das Schema zurück.',
    "Merge Component Schema": "Komponentenschema zusammenführen",
    "Custom Action": "Benutzerdefinierte Aktion",
    "You must assign the show variable a boolean result.":
      "Sie müssen der Show-Variablen ein boolesches Ergebnis zuweisen.",
    "Note: Advanced Conditional logic will override the results of the Simple Conditional logic.":
      "Hinweis: Die erweiterte bedingte Logik überschreibt die Ergebnisse der einfachen bedingten Logik.",
    "example": "Beispiel",
    '"row", "data", "component" and "_" variables are available. Return the result to be passed to the action if truthy.':
      'Die Variablen "row", "data", "component" und "_" sind verfügbar. Gibt das an die Aktion zu übergebende Ergebnis zurück, wenn es wahr ist.',
    ...
    "The settings inside apply only to the PDF forms.":
      "Die darin enthaltenen Einstellungen gelten nur für die PDF-Formulare.",
    ...
    "Left": "Links",
    "The left margin within a page to place this component.":
      "Der linke Rand innerhalb einer Seite, um diese Komponente zu platzieren.",
    "The top margin within a page to place this component.":
      "Der obere Rand innerhalb einer Seite, um diese Komponente zu platzieren.",
    "Width": "Breite",
    "The width of the component (in pixels).":
      "Die Breite der Komponente (in Pixel).",
    "Height": "Höhe",
    "The height of the component (in pixels).":
    ...
    "Always show decimals, even if trailing zeros.":
      "Dezimalstellen immer anzeigen, auch bei nachgestellten Nullen.",
    ...
    "Position for the label for options for this field.":
      "Position für die Bezeichnung für Optionen für dieses Feld.",
    "Right": "Rechts",
    ...
    "Disables search algorithm threshold.":
      "Deaktiviert den Schwellenwert für den Suchalgorithmus.",
    "Theme": "Thema",
    ...
    "This control should span the full width of the bounding container.":
      "Dieses Steuerelement sollte sich über die gesamte Breite des Begrenzungscontainers erstrecken.",
    "Left Icon": "Linkes Symbol",
    "This is the full icon class string to show the icon.":
      "Dies ist die vollständige Symbolklassenzeichenfolge zum Anzeigen des Symbols.",
    ...
    "Key topics for Sentiment Analysis":
      "Schlüsselthemen für die Stimmungsanalyse",
    "Enter topics to use in sentiment Analysis":
      "Geben Sie Themen ein, die in der Stimmungsanalyse verwendet werden sollen",
    "Kickbox": "Kick-Box",
    "Enable": "Aktivierenr",
    "Enable Kickbox validation for this email field.":
    ...
    "Manual Mode View String":
      "Zeichenfolge für die Ansicht im manuellen Modus",
    "Specify template which should be when quering view string for the component value entered in manual mode. This string is used in table view, CSV export and email rendering. When left blank combined value of all components joined with comma will be used.":
      "Geben Sie die Vorlage an, die beim Abfragen der Ansichtszeichenfolge für den im manuellen Modus eingegebenen Komponentenwert verwendet werden soll. Diese Zeichenfolge wird in der Tabellenansicht, beim CSV-Export und beim Rendern von E-Mails verwendet. Wenn das Feld leer gelassen wird, wird der kombinierte Wert aller mit Komma verbundenen Komponenten verwendet.",
    "Azure Maps": "Azure-Karten",
    "Google Maps": "Google Maps",
    "API Key": "API-Schlüssel",
    "Use your Google API key here.":
      "Verwenden Sie hier Ihren Google-API-Schlüssel.",
    "Provider options": "Anbieteroptionen",
    "Delimiter": "Trennzeichen",
    "What is used to separate the tags.":
      "Was wird verwendet, um die Tags zu trennen.",
    "Max Tags": "Max-Tags",
    "The maximum amount of tags that can be added. 0 for infinity.":
      "Die maximale Anzahl an Tags, die hinzugefügt werden können. 0 für unendlich.",
    "Store As": "Speichern als",
    "String (CSV)": "Zeichenfolge (CSV)",
    "Array of Tags": "Array von Tags",
    "Display in Timezone": "Anzeige in Zeitzone",
    "This will display the captured date time in the select timezone.":
      "Dadurch wird die erfasste Datumszeit in der ausgewählten Zeitzone angezeigt.",
    ...
    "Use locale settings to display date and time.":
      "Verwenden Sie Gebietsschemaeinstellungen, um Datum und Uhrzeit anzuzeigen.",
    "Allow Manual Input": "Manuelle Eingabe zulassen",
    "Check this if you would like to allow the user to manually enter in the date.":
      "Aktivieren Sie dies, wenn Sie dem Benutzer erlauben möchten, das Datum manuell einzugeben.",
    "Format": "Format",
    "The date format for displaying the datetime value.":
      "Das Datumsformat zum Anzeigen des datetime-Werts.",
    "Shortcut Buttons": "Shortcut-Schaltflächen",
    "You can specify few buttons which will be shown above the calendar. Use Label to specify the name of the button and onClick to specify which date/time will be set when user clicks the button. ":
      "Sie können einige Schaltflächen angeben, die über dem Kalender angezeigt werden. Verwenden Sie Label, um den Namen der Schaltfläche anzugeben, und onClick, um anzugeben, welches Datum/welche Uhrzeit festgelegt wird, wenn der Benutzer auf die Schaltfläche klickt.",
    "onClick": "onClick",
    "Enable Date Input": "Datumseingabe aktivieren",
    "Enables date input for this field.":
      "Aktiviert die Datumseingabe für dieses Feld.",
    "Use Input to add moment.js for minDate":
      "Verwenden Sie Input, um moment.js für minDate hinzuzufügen",
    "Enables to use input for moment functions instead of calendar.":
      "Ermöglicht die Verwendung von Eingaben für Momentfunktionen anstelle des Kalenders.",
    "Use calendar to set minDate":
      "Verwenden Sie den Kalender, um minDate festzulegen",
    "Enables to use calendar to set date.":
      "Ermöglicht die Verwendung des Kalenders zum Festlegen des Datums.",
    "Use Input to add moment.js for maxDate":
      "Verwenden Sie Input, um moment.js für maxDate hinzuzufügen",
    "Use calendar to set maxDate":
      "Verwenden Sie den Kalender, um maxDate festzulegen",
    "Disable specific dates or dates by range":
      "Deaktivieren Sie bestimmte Daten oder Daten nach Bereich",
    "Add dates that you want to blacklist. For example:":
      "Fügen Sie Daten hinzu, die Sie auf die schwarze Liste setzen möchten. Zum Beispiel:",
    ...
    "Enables time input for this field":
      "Aktiviert die Zeiteingabe für dieses Feld",
    "Hour Step Size": "Stundenschrittgröße",
    "The number of hours to increment/decrement in the time picker.":
      "Die Anzahl der Stunden, um die in der Zeitauswahl erhöht/verringert werden soll.",
    "Minute Step Size": "Minute Schrittgröße",
    "The number of minutes to increment/decrement in the time picker.":
      "Die Anzahl der Minuten, um die in der Zeitauswahl erhöht/verringert werden soll.",
    "Display time in 12 hour time with AM/PM.":
      "Anzeigezeit im 12-Stunden-Format mit AM/PM.",
    ...
    "The attributes for this HTML element. Only safe attributes are allowed, such as src, href, and title.":
      "Die Attribute für dieses HTML-Element. Nur sichere Attribute sind erlaubt, wie src, href und title.",
    "Attribute": "Attribut",
    "Refresh On Change": "Bei Änderung aktualisieren",
    "HTML Element": "HTML-Element",
    "Column Properties": "Spalteneigenschaften",
    "The width, offset, push, and pull settings for each column.":
      "Die Einstellungen für Breite, Offset, Push und Pull für jede Spalte.",
    "Offset": "Versatz",
    "Push": "Drücken",
    "Pull": "Ziehen",
    "Auto adjust columns": "Spalten automatisch anpassen",
    "Will automatically adjust columns based on if nested components are hidden.":
      "Passt Spalten automatisch an, je nachdem, ob verschachtelte Komponenten ausgeblendet sind.",
    "Hide Column when Children Hidden":
      "Spalte ausblenden, wenn untergeordnete Elemente ausgeblendet sind",
    "Check this if you would like to hide any column when the children within that column are also hidden":
      "Aktivieren Sie dies, wenn Sie eine Spalte ausblenden möchten, wenn die untergeordneten Elemente in dieser Spalte ebenfalls ausgeblendet sind",
    "Legend": "Legende",
    "The legend for this Fieldset.": "Die Legende für dieses Fieldset.",
    "Default": "Standard",
    "Collapsible": "zusammenklappbar",
    "If checked, this will turn this Panel into a collapsible panel.":
      "Wenn diese Option aktiviert ist, wird dieses Panel zu einem zusammenklappbaren Panel.",
    "Number of Rows": "anzahl der Zeilen",
    "Enter the number or rows that should be displayed by this table.":
      "Geben Sie die Anzahl oder Zeilen ein, die von dieser Tabelle angezeigt werden sollen.",
    "Number of Columns": "Anzahl der Spalten",
    "Enter the number or columns that should be displayed by this table.":
      "Geben Sie die Anzahl oder Spalten ein, die von dieser Tabelle angezeigt werden sollen.",
    ...
    "Disable Adding / Removing Rows":
      "Deaktivieren Sie das Hinzufügen/Entfernen von Zeilen",
    "Check if you want to hide Add Another button and Remove Row button":
      "Stellen Sie sicher, dass Sie die Schaltflächen „Andere hinzufügen“ und „Zeile entfernen“ ausblenden möchten",
    ...
    "The form to load within this form component.":
      "Das Formular, das in diese Formularkomponente geladen werden soll.",
    "Form Revision": "Formularüberarbeitung",
    "You can lock the nested form to a specific revision by entering the revision number here.":
      "Sie können das verschachtelte Formular für eine bestimmte Revision sperren, indem Sie hier die Revisionsnummer eingeben.",
    "Use Original Revision while Submissions Viewing":
    ...
    "The properties on the resource to return as part of the options. If left blank, all properties will be returned.":
      "Die Eigenschaften der Ressource, die als Teil der Optionen zurückgegeben werden sollen. Wenn das Feld leer gelassen wird, werden alle Eigenschaften zurückgegeben.",
    "Search Fields": "Suchfelder",
    "Filter Query": "Filterabfrage",
    "Use this to provide additional filtering using query parameters.":
      "Verwenden Sie dies, um eine zusätzliche Filterung mithilfe von Abfrageparametern bereitzustellen.",
    "The filter query for results.": "Die Filterabfrage für Ergebnisse.",
    "Sort Query": "Abfrage sortieren",
    "Use this to provide additional sorting using query parameters":
      "Verwenden Sie dies, um eine zusätzliche Sortierung mithilfe von Abfrageparametern bereitzustellen",
    "The sort query for results": "Die Sortierabfrage für Ergebnisse",
    "Add Resource": "Ressource hinzufügen",
    "Allows to create a new resource while entering a submission.":
      "Ermöglicht das Erstellen einer neuen Ressource während der Eingabe einer Einreichung.",
    ...
    "Please fix the errors before submitting again.":
      "Bitte beheben Sie die Fehler, bevor Sie sie erneut senden.",
    "No submissions available for the selected date range":
      "Für den ausgewählten Zeitraum sind keine Einreichungen verfügbar",
    "OK": "OK",
